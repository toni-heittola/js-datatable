...
function valueFormatter_float1_percentage_with_interval_muted(value,row,index){if(isNumericWithInterval(value)){var numbers=value.match(/[+-]?\d+(?:\.\d+)/g);return parseFloat(numbers[0]).toFixed(1)+' % <span class="text-muted">('+parseFloat(numbers[1]).toFixed(1)+' - '+parseFloat(numbers[2]).toFixed(1)+')</span>';}else if($.isNumeric(value)){return parseFloat(value).toFixed(1)+' %';}else{return value;}}
...
function valueFormatter_float2_percentage_with_interval_muted(value,row,index){if(isNumericWithInterval(value)){var numbers=value.match(/[+-]?\d+(?:\.\d+)/g);return parseFloat(numbers[0]).toFixed(2)+' % <span class="text-muted">('+parseFloat(numbers[1]).toFixed(2)+' - '+parseFloat(numbers[2]).toFixed(2)+')</span>';}else if($.isNumeric(value)){return parseFloat(value).toFixed(2)+' %';}else{return value;}}
...
function valueFormatter_float3_percentage_with_interval_muted(value,row,index){if(isNumericWithInterval(value)){var numbers=value.match(/[+-]?\d+(?:\.\d+)/g);return parseFloat(numbers[0]).toFixed(3)+' % <span class="text-muted">('+parseFloat(numbers[1]).toFixed(3)+' - '+parseFloat(numbers[2]).toFixed(3)+')</span>';}else if($.isNumeric(value)){return parseFloat(value).toFixed(3)+' %';}else{return value;}}
...
function valueFormatter_float4_percentage_with_interval_muted(value,row,index){if(isNumericWithInterval(value)){var numbers=value.match(/[+-]?\d+(?:\.\d+)/g);return parseFloat(numbers[0]).toFixed(4)+' % <span class="text-muted">('+parseFloat(numbers[1]).toFixed(4)+' - '+parseFloat(numbers[2]).toFixed(4)+')</span>';}else if($.isNumeric(value)){return parseFloat(value).toFixed(4)+' %';}else{return value;}}
