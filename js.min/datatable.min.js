...
var value_label=header.text().trim();if(typeof header.data('axis-label')!=='undefined'){var value_label=$("<div/>").html(header.data('axis-label')).text().trim();}
var labels=[];var data=[];var border_colors=[];var border_hover_colors=[];var bg_colors=[];var bg_hover_colors=[];this.hline_value=[];this.hline_color=[];this.hline_index=[];for(var i=0;i<table_data.length;i++){var label=$("<div/>").html(table_data[i][this.options.table.id_field]).text().trim().replace(/<(?:.|\n)*?>/gm,'').replace('_',' ');if(labels.indexOf(label)>-1){var num_of_occurances=0;for(var i=0;i<labels.length;i++){if(labels[i]===label)
num_of_occurances++;}
...
return false;}});var table_options=$(this.element).bootstrapTable('getOptions');var table_data=$(this.element).bootstrapTable('getData');var sort_name=table_options.sortName;var id_field=table_options.idField;var chartable=$(this.element).find('thead tr th[data-field=\"'+sort_name+'\"]').data('chartable');var labels=[];var data=[];var border_colors=[];var border_hover_colors=[];var bg_colors=[];var bg_hover_colors=[];var point_radius=[];var point_hover_radius=[];for(var i=0;i<table_data.length;i++){labels.push($("<div/>").html(table_data[i][this.options.table.id_field]).text().replace(/<(?:.|\n)*?>/gm,''));if(table_data[i].hasOwnProperty('_class')&&typeof table_data[i]['_class']!=='undefined'){if(this.options.scatter.colors.valid.indexOf(table_data[i]['_class'])>-1){border_colors.push(this.options.scatter.colors[table_data[i]['_class']].border.normal);border_hover_colors.push(this.options.scatter.colors[table_data[i]['_class']].border.hover);bg_colors.push(this.options.scatter.colors[table_data[i]['_class']].bg.normal);bg_hover_colors.push(this.options.scatter.colors[table_data[i]['_class']].border.hover);}else{border_colors.push(this.options.scatter.colors.default.border.normal);border_hover_colors.push(this.options.scatter.colors.default.border.hover);bg_colors.push(this.options.scatter.colors.default.bg.normal);bg_hover_colors.push(this.options.scatter.colors.default.bg.hover);}}else{border_colors.push(this.options.scatter.colors.default.border.normal);border_hover_colors.push(this.options.scatter.colors.default.border.hover);bg_colors.push(this.options.scatter.colors.default.bg.normal);bg_hover_colors.push(this.options.scatter.colors.default.bg.hover);}
...
var labels=[];var set_a_data=[];var set_b_data=[];for(var field_id=0;field_id<set_fields.length;field_id++){if(set_fields[field_id].chartable){labels.push(set_fields[field_id].title);set_a_data.push(parseFloat(data_a[set_fields[field_id].field]));set_b_data.push(parseFloat(data_b[set_fields[field_id].field]));}}
...
$.each(sortable,function(i,val){map[val[0]]=i;});$.each(this.field_meta,function(index,meta){console.log(meta);if(meta.tag){$(self.element).find('tbody tr').each(function(){var value=$(this).find('td').eq(index).text().trim();var html='';value.split(',').forEach(function(item){var tag_css=self.options.tags.css[map[item]];if(tag_css==undefined){var tag_css=self.options.tags.css[self.options.tags.css.length-1];}
html+='<span class="'+tag_css+'">'+item+'</span>';});$(this).find('td').eq(index).html(html);})}})}else if(this.options.tag_mode=='column'){var map={};$.each(this.field_meta,function(index,meta){if(meta.tag){var values={};$(self.element).find('tbody tr').each(function(){var value=$(this).find('td').eq(index).text().trim();value.split(',').forEach(function(item){if(!(item.trim()in values)){values[item.trim()]=0;}
values[item.trim()]++;});});var sortable=[];for(var value_group in values){sortable.push([value_group,values[value_group]]);sortable.sort(function(a,b){return b[1]-a[1]})}
$.each(sortable,function(i,val){map[val[0]]=i;});$(self.element).find('tbody tr').each(function(){var value=$(this).find('td').eq(index).text().trim();var html='';value.split(',').forEach(function(item){var tag_css=self.options.tags.css[map[item]];if(tag_css==undefined){var tag_css=self.options.tags.css[self.options.tags.css.length-1];}
...
$(this.element).bootstrapTable('updateCell',{index:0,field:'rank',value:'-'});},getRank:function(index){return this.table_rank[index];},log:function(string){if(this.options.debug){console.log(string);}},stripHTML:function(element){return $("<div/>").html(element).text();}};function getRank(index){if(typeof $(this).data(pluginName)!=='undefined'){return $(this).data(pluginName).getRank(index);}else{return'';}}
function updateChart(){$(this).data(pluginName).updateChart();}
$.fn[pluginName]=function(options){var element=$(this);var name=pluginName;if(options===undefined||typeof options==='object'){return this.map(function(){var $t=$(this);var object=$t.data(name);if(undefined==object){var plugin=new Plugin(element,$.extend(true,{},defaults,options),name);$t.data(name,plugin);}});}else if(typeof options==='string'){var args=Array.prototype.slice.call(arguments);args.splice(0,1);return commands[arguments[0]].apply(element,args);}}}(jQuery,window,document));function valueSorter(a,b){if(a.trim()){var a_float=parseFloat(a.replace('%',''));if(!isNaN(a_float)){a=a_float;}}else{a=-Infinity;}
if(b.trim()){var b_float=parseFloat(b.replace('%',''));if(!isNaN(b_float)){b=b_float;}}else{b=-Infinity;}
if(a<b){return-1;}
if(a>b){return 1;}
return 0;}
function valueSorterReverse(a,b){if(a.trim()){var a_float=parseFloat(a.replace('%',''));if(!isNaN(a_float)){a=a_float;}}else{a=Infinity;}
if(b.trim()){var b_float=parseFloat(b.replace('%',''));if(!isNaN(b_float)){b=b_float;}}else{b=Infinity;}
if(a<b){return-1;}
if(a>b){return 1;}
return 0;}
...
function valueFormatter_float1_error(value,row,index){if($.isNumeric(value)){return'±'+parseFloat(value).toFixed(1);}else{return value;}}
function valueFormatter_float2_error(value,row,index){if($.isNumeric(value)){return'±'+parseFloat(value).toFixed(2);}else{return value;}}
function valueFormatter_float3_error(value,row,index){if($.isNumeric(value)){return'±'+parseFloat(value).toFixed(3);}else{return value;}}
function valueFormatter_float4_error(value,row,index){if($.isNumeric(value)){return'±'+parseFloat(value).toFixed(4);}else{return value;}}
function valueFormatter_float1_percentage_with_interval(value,row,index){if(isNumericWithInterval(value)){var numbers=value.match(/[+-]?\d+(?:\.\d+)/g);return parseFloat(numbers[0]).toFixed(1)+' % ('+parseFloat(numbers[1]).toFixed(1)+' - '+parseFloat(numbers[2]).toFixed(1)+')';}else if($.isNumeric(value)){return parseFloat(value).toFixed(1)+' %';}else{return value;}}
function valueFormatter_float1_percentage_with_interval_muted(value,row,index){if(isNumericWithInterval(value)){var numbers=value.match(/[+-]?\d+(?:\.\d+)/g);return parseFloat(numbers[0]).toFixed(1)+' % <small class="text-muted">('+parseFloat(numbers[1]).toFixed(1)+' - '+parseFloat(numbers[2]).toFixed(1)+')</small>';}else if($.isNumeric(value)){return parseFloat(value).toFixed(1)+' %';}else{return value;}}
function valueFormatter_float2_percentage_with_interval(value,row,index){if(isNumericWithInterval(value)){var numbers=value.match(/[+-]?\d+(?:\.\d+)/g);return parseFloat(numbers[0]).toFixed(2)+' % ('+parseFloat(numbers[1]).toFixed(2)+' - '+parseFloat(numbers[2]).toFixed(2)+')';}else if($.isNumeric(value)){return parseFloat(value).toFixed(2)+' %';}else{return value;}}
function valueFormatter_float2_percentage_with_interval_muted(value,row,index){if(isNumericWithInterval(value)){var numbers=value.match(/[+-]?\d+(?:\.\d+)/g);return parseFloat(numbers[0]).toFixed(2)+' % <small class="text-muted">('+parseFloat(numbers[1]).toFixed(2)+' - '+parseFloat(numbers[2]).toFixed(2)+')</small>';}else if($.isNumeric(value)){return parseFloat(value).toFixed(2)+' %';}else{return value;}}
function valueFormatter_float3_percentage_with_interval(value,row,index){if(isNumericWithInterval(value)){var numbers=value.match(/[+-]?\d+(?:\.\d+)/g);return parseFloat(numbers[0]).toFixed(3)+' % ('+parseFloat(numbers[1]).toFixed(3)+' - '+parseFloat(numbers[2]).toFixed(3)+')';}else if($.isNumeric(value)){return parseFloat(value).toFixed(3)+' %';}else{return value;}}
function valueFormatter_float3_percentage_with_interval_muted(value,row,index){if(isNumericWithInterval(value)){var numbers=value.match(/[+-]?\d+(?:\.\d+)/g);return parseFloat(numbers[0]).toFixed(3)+' % <small class="text-muted">('+parseFloat(numbers[1]).toFixed(3)+' - '+parseFloat(numbers[2]).toFixed(3)+')</small>';}else if($.isNumeric(value)){return parseFloat(value).toFixed(3)+' %';}else{return value;}}
function valueFormatter_float4_percentage_with_interval(value,row,index){if(isNumericWithInterval(value)){var numbers=value.match(/[+-]?\d+(?:\.\d+)/g);return parseFloat(numbers[0]).toFixed(4)+' % ('+parseFloat(numbers[1]).toFixed(4)+' - '+parseFloat(numbers[2]).toFixed(4)+')';}else if($.isNumeric(value)){return parseFloat(value).toFixed(4)+' %';}else{return value;}}
function valueFormatter_float4_percentage_with_interval_muted(value,row,index){if(isNumericWithInterval(value)){var numbers=value.match(/[+-]?\d+(?:\.\d+)/g);return parseFloat(numbers[0]).toFixed(4)+' % <small class="text-muted">('+parseFloat(numbers[1]).toFixed(4)+' - '+parseFloat(numbers[2]).toFixed(4)+')</small>';}else if($.isNumeric(value)){return parseFloat(value).toFixed(4)+' %';}else{return value;}}
