...
return html;}
break;case'inline-bar-horizontal-average':var value_formatter=null;if(typeof header.data('inline-value-type')!=='undefined'){value_formatter=this.createNumericValueFormatter(header.data('inline-value-type'),index);}else{value_formatter=this.createNumericValueFormatter('int-percentile-muted',index);}
window[formatter_function_name]=function(value,row,index){var show_values=false;if(typeof header.data('inline-show-values')!=='undefined'){show_values=header.data('inline-show-values');}
...
var bar_type_thin=false;if(typeof header.data('inline-bar-type')!=='undefined'){if(header.data('inline-bar-type')=='thin'){bar_type_thin=true;}}
...
var data=self.parseDataList(value);var html='';if(data.length>0){var current_value=data[0]['y_value'];var value_string=window[value_formatter](current_value);if(bar_type_thin){html+='<div class="progress datatable-horizontal-bar-thin">'}else{html+='<div class="progress datatable-horizontal-bar">'}
if(current_value<=50){html+='<div class="progress-bar" role="progressbar" style="width: '+current_value+'%;background-color:'+self.options.inline_chart.bar_horizontal_average.colors.background+'" ></div>';html+='<div class="progress-bar" role="progressbar" style="width: '+(50-current_value)+'%;background-color:'+self.options.inline_chart.bar_horizontal_average.colors.negative+';border-right: 1px solid '+self.options.inline_chart.bar_horizontal_average.colors.center+';" ></div>';html+='<div class="progress-bar" role="progressbar" style="width: 50%;background-color:'+self.options.inline_chart.bar_horizontal_average.colors.background+';border-left: 1px solid '+self.options.inline_chart.bar_horizontal_average.colors.center+';" ></div>';}else if(current_value>50){html+='<div class="progress-bar" role="progressbar" style="width: 50%;background-color:'+self.options.inline_chart.bar_horizontal_average.colors.background+';border-right: 1px solid '+self.options.inline_chart.bar_horizontal_average.colors.center+';" ></div>';html+='<div class="progress-bar" role="progressbar" style="width: '+(current_value-50)+'%;background-color:'+self.options.inline_chart.bar_horizontal_average.colors.positive+';border-left: 1px solid '+self.options.inline_chart.bar_horizontal_average.colors.center+';" ></div>';html+='<div class="progress-bar" role="progressbar" style="width: '+(100-current_value)+'%;background-color:'+self.options.inline_chart.bar_horizontal_average.colors.background+';" ></div>';}
html+='</div>';if(show_values){if(small_values){if(muted_values){html+='<small class="text-muted">'+value_string+'</small>';}else{html+='<small>'+value_string+'</small>';}}else{if(muted_values){html+='<span class="text-muted">'+value_string+'</span>';}else{html+=value_string;}}}}
return html;}
