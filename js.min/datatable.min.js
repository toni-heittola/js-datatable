...
scatter_div+='<li'+active+'><a data-field="'+field+'" data-postfix="'+postfix+'" data-reversed="'+reversed+'" data-selected="'+selected+'" href="#" onclick="return false;">'+$.trim($(this).text())+'</a></li>'});scatter_div+='</ul>';scatter_div+='</div>';scatter_div+='</div>';scatter_div+='<div class="btn-group">';scatter_div+='<div class="dropdown">';scatter_div+='<button aria-expanded="false" aria-haspopup="true" class="btn btn-default dropdown-toggle" data-toggle="dropdown" id="scatter_selector_y'+this.uniqueId+'" type="button">Y '+this.options.icon.caret+'</button>';scatter_div+='<ul aria-labelledby="scatter_selector_y'+this.uniqueId+'" class="dropdown-menu" id="scatter_selector_y_menu'+this.uniqueId+'" role="menu">';scatter_div+='<li class="dropdown-header">'+this.options.label.select_y_axis+'</li>';$(this.element).find('thead tr th[data-chartable="true"]').each(function(){var postfix='';if(typeof $(this).data('postfix')!=='undefined'){postfix=$(this).data('postfix');}
var reversed=false;if(typeof $(this).data('reversed')!=='undefined'){reversed=$(this).data('reversed');}
if(typeof $(this).data('field')!=='undefined'){var field=$(this).data('field');}
var active='';var selected='0';if(field==self.options.scatter.y){active=' class="active" ';selected='1';}
scatter_div+='<li'+active+'><a data-field="'+field+'" data-postfix="'+postfix+'" data-reversed="'+reversed+'" data-selected="'+selected+'" href="#" onclick="return false;">'+$.trim($(this).text())+'</a></li>'});scatter_div+='</ul>';scatter_div+='</div>';scatter_div+='</div>';scatter_div+='</div>';scatter_div+='</div>';this.options.element.scatter.div='#scatter_div'+this.uniqueId;this.options.element.scatter.canvas='#scatter_chart'+this.uniqueId;this.options.element.scatter.selector_x_menu='#scatter_selector_x_menu'+this.uniqueId;this.options.element.scatter.selector_y_menu='#scatter_selector_y_menu'+this.uniqueId;$($div).append(scatter_div);$(document).on("click",this.options.element.scatter.selector_x_menu+' li a',function(){$(self.options.element.scatter.selector_x_menu+' li a').each(function(){$(this).data('selected',0);$(this).parent().removeClass('active');});$(this).data('selected',1);$(this).parent().addClass('active');self.updateScatter();});$(document).on("click",this.options.element.scatter.selector_y_menu+' li a',function(){$(self.options.element.scatter.selector_y_menu+' li a').each(function(){$(this).data('selected',0);$(this).parent().removeClass('active');});$(this).data('selected',1);$(this).parent().addClass('active');self.updateScatter();});}
...
var value_label=header.text().trim();if(typeof header.data('bar-chart-yaxis-label')!=='undefined'){var value_label=$("<div/>").html(header.data('bar-chart-yaxis-label')).text().trim();}
