...
var data=self.parseDataList($(this).data('value'));var width=self.options.inline_chart.max_width;if(self.options.inline_chart.bar_vertical.item_width){width=data.length*(self.options.inline_chart.bar_vertical.item_width+3);self.options.inline_chart.bar_vertical.options.scales.xAxes[0].barThickness=self.options.inline_chart.bar_vertical.item_width}
if(width>self.options.inline_chart.max_width){width=self.options.inline_chart.max_width;self.options.inline_chart.bar_vertical.options.scales.xAxes[0].barThickness=(self.options.inline_chart.max_width-3)/data.length}
$(this).attr("width",width);$(this).attr("height",self.options.inline_chart.height);var values=[];var labels=[];var bg_colors=[];var min_y_value=Infinity;var max_y_value=-Infinity;for(var i=0;i<data.length;i++){values.push(parseFloat(data[i]['y_value']));var current_color=null;if(data[i]['color']){current_color=data[i]['color'];}else if(i<dataset_colors.length&&dataset_colors[i]){current_color=dataset_colors[i];}else{current_color=self.options.inline_chart.bar_vertical.colors.default;}
...
self.chart_update=true;});this.initFieldMeta();this.loadTableData();},initOptions:function(options){var attributes=jQuery.extend(true,{},this.defaults);if(typeof this.$element.data('show-chart')!=='undefined'){attributes.show_chart=this.$element.data('show-chart');}
...
if(typeof this.$element.data('bar-height')!=='undefined'){attributes.bar.height=this.$element.data('bar-height');}
if(typeof this.$element.data('bar-hline')!=='undefined'){attributes.bar.horizontal_line.enabled=this.$element.data('bar-hline');}
if(typeof this.$element.data('bar-show-xaxis')!=='undefined'){attributes.bar.xaxis.display=this.$element.data('bar-show-xaxis');}
if(typeof this.$element.data('bar-show-yaxis')!=='undefined'){attributes.bar.yaxis.display=this.$element.data('bar-show-yaxis');}
if(typeof this.$element.data('bar-yaxis-gridlines')!=='undefined'){attributes.bar.yaxis.gridlines=this.$element.data('bar-yaxis-gridlines');}
if(typeof this.$element.data('bar-horizontal-highlights')!=='undefined'){attributes.bar.horizontal_highlights.data=this.parseDataList(this.$element.data('bar-horizontal-highlights'));if(attributes.bar.horizontal_highlights.data.length==0&&attributes.bar.horizontal_highlights.enabled){attributes.bar.horizontal_highlights.enabled=false;}}
if(typeof this.$element.data('bar-horizontal-highlight-opacity')!=='undefined'){attributes.bar.horizontal_highlights.opacity=this.$element.data('bar-horizontal-highlight-opacity');}
if(typeof this.$element.data('bar-horizontal-highlight-linewidth')!=='undefined'){attributes.bar.horizontal_highlights.lineWidth=this.$element.data('bar-horizontal-highlight-width');}
if(typeof this.$element.data('bar-horizontal-highlight-stroke')!=='undefined'){attributes.bar.horizontal_highlights.strokeStyle=this.$element.data('bar-horizontal-highlight-stroke');}
if(typeof this.$element.data('bar-horizontal-highlight-label-position')!=='undefined'){attributes.bar.horizontal_highlights.label.position=this.$element.data('bar-horizontal-highlight-label-position');}
if(typeof this.$element.data('bar-horizontal-highlight-label-fill')!=='undefined'){attributes.bar.horizontal_highlights.label.fillStyle=this.$element.data('bar-horizontal-highlight-label-fill');}
if(typeof this.$element.data('bar-horizontal-highlight-label-size')!=='undefined'){attributes.bar.horizontal_highlights.label.fontSize=this.$element.data('bar-horizontal-highlight-label-size');}
if(typeof this.$element.data('bar-horizontal-highlight-label-opacity')!=='undefined'){attributes.bar.horizontal_highlights.label.opacity=this.$element.data('bar-horizontal-highlight-label-opacity');}
if(typeof this.$element.data('bar-show-vertical-indicator')!=='undefined'){attributes.bar.vertical_indicator_line.enabled=this.$element.data('bar-show-vertical-indicator');}
if(typeof this.$element.data('bar-vertical-indicator-linewidth')!=='undefined'){attributes.bar.vertical_indicator_line.lineWidth=this.$element.data('bar-vertical-indicator-width');}
if(typeof this.$element.data('bar-vertical-indicator-stroke')!=='undefined'){attributes.bar.vertical_indicator_line.strokeStyle=this.$element.data('bar-vertical-indicator-stroke');}
if(typeof this.$element.data('bar-show-horizontal-indicator')!=='undefined'){attributes.bar.horizontal_indicator_line.enabled=this.$element.data('bar-show-horizontal-indicator');}
if(typeof this.$element.data('bar-horizontal-indicator-linewidth')!=='undefined'){attributes.bar.horizontal_indicator_line.lineWidth=this.$element.data('bar-horizontal-indicator-width');}
if(typeof this.$element.data('bar-horizontal-indicator-stroke')!=='undefined'){attributes.bar.horizontal_indicator_line.strokeStyle=this.$element.data('bar-horizontal-indicator-stroke');}
if(typeof this.$element.data('bar-horizontal-indicator-fill')!=='undefined'){attributes.bar.horizontal_indicator_line.fillStyle=this.$element.data('bar-horizontal-indicator-fill');}
if(typeof this.$element.data('bar-show-error-bar')!=='undefined'){attributes.bar.error_bar.enabled=this.$element.data('bar-show-error-bar');}
if(typeof this.$element.data('bar-error-bar-linewidth')!=='undefined'){attributes.bar.error_bar.lineWidth=this.$element.data('bar-error-bar-linewidth');}
if(typeof this.$element.data('bar-error-bar-tipwidth')!=='undefined'){attributes.bar.error_bar.tipWidth=this.$element.data('bar-error-bar-tipwidth');}
if(typeof this.$element.data('bar-error-bar-stroke')!=='undefined'){attributes.bar.error_bar.strokeStyle=this.$element.data('bar-error-bar-stroke');}
if(typeof this.$element.data('bar-tooltip-position')!=='undefined'){attributes.bar.tooltips.position=this.$element.data('bar-tooltip-position');}
if(typeof this.$element.data('bar-show-legend')!=='undefined'){attributes.bar.legend.enabled=this.$element.data('bar-show-legend');}
if(typeof this.$element.data('bar-legend-position')!=='undefined'){attributes.bar.legend.position=this.$element.data('bar-legend-position');}
if(typeof this.$element.data('line-fields')!=='undefined'){attributes.line.fields=this.$element.data('line-fields').split(',').map(function(item){return item.trim();});}
if(typeof this.$element.data('line-fill')!=='undefined'){attributes.line.fill=this.$element.data('line-fill');}
if(typeof this.$element.data('line-show-xaxis')!=='undefined'){attributes.line.xaxis.display=this.$element.data('line-show-xaxis');}
if(typeof this.$element.data('line-xaxis-field')!=='undefined'){attributes.line.xaxis.field=this.$element.data('line-xaxis-field');}
if(typeof this.$element.data('line-xaxis-sorted')!=='undefined'){attributes.line.xaxis.sorted=this.$element.data('line-xaxis-sorted');}
if(typeof this.$element.data('line-xaxis-timeunit')!=='undefined'){attributes.line.xaxis.timeunit=this.$element.data('line-xaxis-timeunit');}
if(typeof this.$element.data('line-xaxis-timestepsize')!=='undefined'){attributes.line.xaxis.timestepsize=this.$element.data('line-xaxis-timestepsize');}
if(typeof this.$element.data('line-xaxis-gridlines')!=='undefined'){attributes.line.xaxis.gridlines=this.$element.data('line-xaxis-gridlines');}
if(typeof this.$element.data('line-yaxis-beginatzero')!=='undefined'){attributes.line.yaxis.beginatzero=this.$element.data('line-yaxis-beginatzero');}
if(typeof this.$element.data('line-yaxis-label')!=='undefined'){attributes.line.yaxis.label=this.$element.data('line-yaxis-label');}
if(typeof this.$element.data('line-yaxis-scale')!=='undefined'){attributes.line.yaxis.scale=this.$element.data('line-yaxis-scale');}
if(typeof this.$element.data('line-yaxis-gridlines')!=='undefined'){attributes.line.yaxis.gridlines=this.$element.data('line-yaxis-gridlines');}
if(typeof this.$element.data('line-height')!=='undefined'){attributes.line.height=this.$element.data('line-height');}
if(typeof this.$element.data('line-show-point')!=='undefined'){attributes.line.point.enabled=this.$element.data('line-show-point');}
if(typeof this.$element.data('line-point-radius')!=='undefined'){attributes.line.point.radius.normal=this.$element.data('line-point-radius');}
if(typeof this.$element.data('line-point-radius-hover')!=='undefined'){attributes.line.point.radius.hover=this.$element.data('line-point-radius-hover');}
if(typeof this.$element.data('line-show-line')!=='undefined'){attributes.line.line.enabled=this.$element.data('line-show-line');}
if(typeof this.$element.data('line-show-vertical-indicator')!=='undefined'){attributes.line.vertical_indicator_line.enabled=this.$element.data('line-show-vertical-indicator');}
if(typeof this.$element.data('line-vertical-indicator-linewidth')!=='undefined'){attributes.line.vertical_indicator_line.lineWidth=this.$element.data('line-vertical-indicator-width');}
if(typeof this.$element.data('line-vertical-indicator-stroke')!=='undefined'){attributes.line.vertical_indicator_line.strokeStyle=this.$element.data('line-vertical-indicator-stroke');}
if(typeof this.$element.data('line-show-horizontal-indicator')!=='undefined'){attributes.line.horizontal_indicator_line.enabled=this.$element.data('line-show-horizontal-indicator');}
if(typeof this.$element.data('line-horizontal-indicator-linewidth')!=='undefined'){attributes.line.horizontal_indicator_line.lineWidth=this.$element.data('line-horizontal-indicator-width');}
if(typeof this.$element.data('line-horizontal-indicator-stroke')!=='undefined'){attributes.line.horizontal_indicator_line.strokeStyle=this.$element.data('line-horizontal-indicator-stroke');}
if(typeof this.$element.data('line-horizontal-indicator-fill')!=='undefined'){attributes.line.horizontal_indicator_line.fillStyle=this.$element.data('line-horizontal-indicator-fill');}
if(typeof this.$element.data('line-show-horizontal-highlights')!=='undefined'){attributes.line.horizontal_highlights.enabled=this.$element.data('line-show-horizontal-highlights');}
if(typeof this.$element.data('line-horizontal-highlights')!=='undefined'){attributes.line.horizontal_highlights.data=this.parseDataList(this.$element.data('line-horizontal-highlights'));if(attributes.line.horizontal_highlights.data.length==0&&attributes.line.horizontal_highlights.enabled){attributes.line.horizontal_highlights.enabled=false;}}
if(typeof this.$element.data('line-horizontal-highlight-opacity')!=='undefined'){attributes.line.horizontal_highlights.opacity=this.$element.data('line-horizontal-highlight-opacity');}
if(typeof this.$element.data('line-horizontal-highlight-linewidth')!=='undefined'){attributes.line.horizontal_highlights.lineWidth=this.$element.data('line-horizontal-highlight-width');}
if(typeof this.$element.data('line-horizontal-highlight-stroke')!=='undefined'){attributes.line.horizontal_highlights.strokeStyle=this.$element.data('line-horizontal-highlight-stroke');}
if(typeof this.$element.data('line-horizontal-highlight-label-position')!=='undefined'){attributes.line.horizontal_highlights.label.position=this.$element.data('line-horizontal-highlight-label-position');}
if(typeof this.$element.data('line-horizontal-highlight-label-fill')!=='undefined'){attributes.line.horizontal_highlights.label.fillStyle=this.$element.data('line-horizontal-highlight-label-fill');}
if(typeof this.$element.data('line-horizontal-highlight-label-size')!=='undefined'){attributes.line.horizontal_highlights.label.fontSize=this.$element.data('line-horizontal-highlight-label-size');}
if(typeof this.$element.data('line-horizontal-highlight-label-opacity')!=='undefined'){attributes.line.horizontal_highlights.label.opacity=this.$element.data('line-horizontal-highlight-label-opacity');}
if(typeof this.$element.data('line-show-vertical-segments')!=='undefined'){attributes.line.vertical_segments.enabled=this.$element.data('line-show-vertical-segments');}
if(typeof this.$element.data('line-vertical-segments')!=='undefined'){attributes.line.vertical_segments.data=this.parseSegmentList(this.$element.data('line-vertical-segments'));if(attributes.line.vertical_segments.data.length==0&&attributes.line.vertical_segments.enabled){attributes.line.vertical_segments.enabled=false;}}
if(typeof this.$element.data('line-vertical-segment-opacity')!=='undefined'){attributes.line.vertical_segments.opacity=this.$element.data('line-vertical-segment-opacity');}
if(typeof this.$element.data('line-vertical-segment-label-position')!=='undefined'){attributes.line.vertical_segments.label.position=this.$element.data('line-vertical-segment-label-position');}
if(typeof this.$element.data('line-vertical-segment-label-fill')!=='undefined'){attributes.line.vertical_segments.label.fillStyle=this.$element.data('line-vertical-segment-label-fill');}
if(typeof this.$element.data('line-vertical-segment-label-size')!=='undefined'){attributes.line.vertical_segments.label.fontSize=this.$element.data('line-vertical-segment-label-size');}
if(typeof this.$element.data('line-vertical-segment-label-opacity')!=='undefined'){attributes.line.vertical_segments.label.opacity=this.$element.data('line-vertical-segment-label-opacity');}
if(typeof this.$element.data('line-show-error-bar')!=='undefined'){attributes.line.error_bar.enabled=this.$element.data('line-show-error-bar');}
if(typeof this.$element.data('line-error-bar-linewidth')!=='undefined'){attributes.line.error_bar.lineWidth=this.$element.data('line-error-bar-linewidth');}
if(typeof this.$element.data('line-error-bar-tipwidth')!=='undefined'){attributes.line.error_bar.tipWidth=this.$element.data('line-error-bar-tipwidth');}
if(typeof this.$element.data('line-error-bar-stroke')!=='undefined'){attributes.line.error_bar.strokeStyle=this.$element.data('line-error-bar-stroke');}
if(typeof this.$element.data('line-show-interval')!=='undefined'){attributes.line.interval.enabled=this.$element.data('line-show-interval');}
if(typeof this.$element.data('line-interval-linewidth')!=='undefined'){attributes.line.interval.lineWidth=this.$element.data('line-interval-linewidth');}
if(typeof this.$element.data('line-hline')!=='undefined'){attributes.line.horizontal_line.enabled=this.$element.data('line-hline');}
if(typeof this.$element.data('line-tooltip-position')!=='undefined'){attributes.line.tooltips.position=this.$element.data('line-tooltip-position');}
if(typeof this.$element.data('line-show-legend')!=='undefined'){attributes.line.legend.enabled=this.$element.data('line-show-legend');}
if(typeof this.$element.data('line-legend-position')!=='undefined'){attributes.line.legend.position=this.$element.data('line-legend-position');}
if(typeof this.$element.data('scatter-height')!=='undefined'){attributes.scatter.height=this.$element.data('scatter-height');}
if(typeof this.$element.data('scatter-x')!=='undefined'){attributes.scatter.x=this.$element.data('scatter-x');}
if(typeof this.$element.data('scatter-y')!=='undefined'){attributes.scatter.y=this.$element.data('scatter-y');}
if(typeof this.$element.data('scatter-point-radius')!=='undefined'){attributes.scatter.point.normal=this.$element.data('scatter-point-radius');}
if(typeof this.$element.data('scatter-point-radius-hover')!=='undefined'){attributes.scatter.point.hover=this.$element.data('scatter-point-radius-hover');}
if(typeof this.$element.data('scatter-show-vertical-indicator')!=='undefined'){attributes.scatter.vertical_indicator_line.enabled=this.$element.data('scatter-show-vertical-indicator');}
if(typeof this.$element.data('scatter-vertical-indicator-linewidth')!=='undefined'){attributes.scatter.vertical_indicator_line.lineWidth=this.$element.data('scatter-vertical-indicator-width');}
if(typeof this.$element.data('scatter-vertical-indicator-stroke')!=='undefined'){attributes.scatter.vertical_indicator_line.strokeStyle=this.$element.data('scatter-vertical-indicator-stroke');}
if(typeof this.$element.data('scatter-show-horizontal-indicator')!=='undefined'){attributes.scatter.horizontal_indicator_line.enabled=this.$element.data('scatter-show-horizontal-indicator');}
if(typeof this.$element.data('scatter-horizontal-indicator-linewidth')!=='undefined'){attributes.scatter.horizontal_indicator_line.lineWidth=this.$element.data('scatter-horizontal-indicator-width');}
if(typeof this.$element.data('scatter-horizontal-indicator-stroke')!=='undefined'){attributes.scatter.horizontal_indicator_line.strokeStyle=this.$element.data('scatter-horizontal-indicator-stroke');}
if(typeof this.$element.data('scatter-horizontal-indicator-fill')!=='undefined'){attributes.scatter.horizontal_indicator_line.fillStyle=this.$element.data('scatter-horizontal-indicator-fill');}
if(typeof this.$element.data('scatter-show-error-bar')!=='undefined'){attributes.scatter.error_bar.enabled=this.$element.data('line-show-error-bar');}
if(typeof this.$element.data('scatter-error-bar-linewidth')!=='undefined'){attributes.scatter.error_bar.lineWidth=this.$element.data('scatter-error-bar-linewidth');}
if(typeof this.$element.data('scatter-error-bar-tipwidth')!=='undefined'){attributes.scatter.error_bar.tipWidth=this.$element.data('scatter-error-bar-tipwidth');}
if(typeof this.$element.data('scatter-error-bar-stroke')!=='undefined'){attributes.scatter.error_bar.strokeStyle=this.$element.data('scatter-error-bar-stroke');}
if(typeof this.$element.data('scatter-show-error-box')!=='undefined'){attributes.scatter.error_bar.bounding_box=this.$element.data('line-show-error-box');}
if(typeof this.$element.data('scatter-error-box-fill')!=='undefined'){attributes.scatter.error_bar.fillStyle=this.$element.data('scatter-error-box-fill');}
if(typeof this.$element.data('comparison-height')!=='undefined'){attributes.comparison.height=this.$element.data('comparison-height');}
if(typeof this.$element.data('comparison-row-id-field')!=='undefined'){attributes.comparison.row_id_field=this.$element.data('comparison-row-id-field');}
if(typeof this.$element.data('comparison-sets-json')!=='undefined'){attributes.comparison.sets=this.$element.data('comparison-sets-json');}
if(typeof this.$element.data('comparison-active-set')!=='undefined'){attributes.comparison.active_set=this.$element.data('comparison-active-set');}
if(typeof this.$element.data('comparison-a-row')!=='undefined'){attributes.comparison.a_row=this.$element.data('comparison-a-row');}
if(typeof this.$element.data('comparison-b-row')!=='undefined'){attributes.comparison.b_row=this.$element.data('comparison-b-row');}
if(typeof this.$element.data('comparison-show-error-bar')!=='undefined'){attributes.comparison.error_bar.enabled=this.$element.data('comparison-show-error-bar');}
if(typeof this.$element.data('comparison-error-bar-linewidth')!=='undefined'){attributes.comparison.error_bar.lineWidth=this.$element.data('comparison-error-bar-linewidth');}
if(typeof this.$element.data('comparison-error-bar-tipwidth')!=='undefined'){attributes.comparison.error_bar.tipWidth=this.$element.data('comparison-error-bar-tipwidth');}
if(typeof this.$element.data('comparison-error-bar-stroke')!=='undefined'){attributes.comparison.error_bar.strokeStyle=this.$element.data('comparison-error-bar-stroke');}
this.options=jQuery.extend(true,{},attributes,options);if(typeof this.$element.data('page-list')==='undefined'){this.$element.attr('data-page-list',this.options.table.page_list);}
...
html+='>';html+='</div>';}
html+='</div>';}
return html;};$(this).attr('data-formatter','valueFormatter_inline_bar_horizontal_percentage'+self.uniqueId);break;case'inline-bar-horizontal-thin-percentage':window['valueFormatter_inline_bar_horizontal_thin_percentage'+self.uniqueId]=function(value,row,index){var value_formatter='valueFormatter_float1_percentage';var header=$(that);var dataset_labels=[];if(typeof header.data('dataset-labels')!=='undefined'){dataset_labels=header.data('dataset-labels').split(',')}
var dataset_colors=[];if(typeof header.data('dataset-colors')!=='undefined'){dataset_colors=header.data('dataset-colors').split(',')}
var data=self.parseDataList(value);var html='';if(data.length>0){var value_sum=0;for(var i=0;i<data.length;i++){value_sum+=data[i]['y_value'];}
...
html+='>';html+='</div>';}
html+='</div>';}
return html;};$(this).attr('data-formatter','valueFormatter_inline_bar_horizontal_thin_percentage'+self.uniqueId);break;case'inline-bar-vertical':window['valueFormatter_inline_bar_vertical'+self.uniqueId]=function(value,row,index){var header=$(that);var items=value.split(',');var html='';if(items.length>0){html+='<canvas class="datatable-inline-bar-vertical" data-value="'+value+'"';if(typeof header.data('dataset-labels')!=='undefined'){html+=' data-dataset-labels="'+header.data('dataset-labels')+'" '}
if(typeof header.data('dataset-colors')!=='undefined'){html+=' data-dataset-colors="'+header.data('dataset-colors')+'" '}
html+='></canvas>';}
return html;};$(this).attr('data-formatter','valueFormatter_inline_bar_vertical'+self.uniqueId);break;case'inline-bar-vertical-tristate':$(this).attr('data-formatter','valueFormatter_inline_bar_vertical_tristate');break;case'inline-line':$(this).attr('data-formatter','valueFormatter_inline_line');break;case'inline-line-steps':$(this).attr('data-formatter','valueFormatter_inline_line_steps');break;case'inline-pie':$(this).attr('data-formatter','valueFormatter_inline_pie');break;case'inline-indicator-value':window['valueFormatter_inline_indicator_value_svg'+self.uniqueId]=function(value,row,index){var data=self.parseDataList(value);var html='';if(data.length>0){for(var i=0;i<data.length;i++){var fill_color='transparent';if(!!data[i]['color']){fill_color=data[i]['color'];}else{fill_color=self.options.inline_chart.value_indicator.color.default;}
...
return html;};$(this).attr('data-formatter','valueFormatter_inline_indicator_value_svg'+self.uniqueId);break;case'inline-indicator-value-html':window['valueFormatter_inline_indicator_value_html'+self.uniqueId]=function(value,row,index){var data=self.parseDataList(value);var html='';if(data.length>0){html='<div class="">';for(var i=0;i<data.length;i++){var css_class=self.options.inline_chart.value_indicator.html.css;var fill_color='transparent';if(!!data[i]['color']){fill_color=data[i]['color'];}else{fill_color=self.options.inline_chart.value_indicator.color.default;}
...
html+='</div>';}
return html;};$(this).attr('data-formatter','valueFormatter_inline_indicator_value_html'+self.uniqueId);break;case'inline-indicator-binary':window['valueFormatter_inline_indicator_binary_svg'+self.uniqueId]=function(value,row,index){var data=self.parseDataList(value);var html='';if(data.length>0){for(var i=0;i<data.length;i++){var fill_color=null;if(data[i]['y_value']>=self.options.inline_chart.value_indicator.data.binarizationThreshold){fill_color=self.options.inline_chart.value_indicator.color.positive;}else{fill_color=self.options.inline_chart.value_indicator.color.negative;}
html+=self.svgElement(self.options.inline_chart.value_indicator.svg.type,self.options.inline_chart.value_indicator.svg.size,fill_color,data[i]['label'],false,0);}}
return html;};$(this).attr('data-formatter','valueFormatter_inline_indicator_binary_svg'+self.uniqueId);break;case'inline-indicator-binary-html':window['valueFormatter_inline_binary_html'+self.uniqueId]=function(value,row,index){var data=self.parseDataList(value);var html='';if(data.length>0){html='<div class="">';for(var i=0;i<data.length;i++){var css_class=self.options.inline_chart.value_indicator.html.css;var fill_color='transparent';if(data[i]['y_value']>self.options.inline_chart.value_indicator.data.binarizationThreshold){fill_color=self.options.inline_chart.value_indicator.color.positive;}else{fill_color=self.options.inline_chart.value_indicator.color.negative;}
html+='<span class="'+css_class+'" aria-hidden="true" ';if(data[i]['label']){html+='data-toggle="tooltip" data-placement="bottom" title="'+data[i]['label']+'"';}
html+=' style="color:'+fill_color+'"';html+='>';html+='</span>';}
html+='</div>';}
return html;};$(this).attr('data-formatter','valueFormatter_inline_binary_html'+self.uniqueId);break;case'inline-indicator-tristate':window['valueFormatter_inline_indicator_tristate_svg'+self.uniqueId]=function(value,row,index){var data=self.parseDataList(value);var html='';if(data.length>0){for(var i=0;i<data.length;i++){var fill_color='transparent';var offset=0;if(data[i]['y_value']>self.options.inline_chart.value_indicator.data.binarizationThreshold){fill_color=self.options.inline_chart.value_indicator.color.positive;offset=0;}else if(data[i]['y_value']<self.options.inline_chart.value_indicator.data.binarizationThreshold){fill_color=self.options.inline_chart.value_indicator.color.negative;offset=self.options.inline_chart.value_indicator.svg.size;}else{fill_color=self.options.inline_chart.value_indicator.color.equal;offset=self.options.inline_chart.value_indicator.svg.size/2;}
...
self.updateTableVisibility(self.table_mode);});$('#'+this.options.element.chart_mode_selector+' label').on('click',function(){self.chart_mode=$(this).data('mode');self.updateVisualizationVisibility(self.chart_mode);});},loadTableData:function(){var self=this;if(typeof this.$element.data('json')!=='undefined'){var json_datafile=this.$element.data('json');jQuery.ajax({type:'GET',mimeType:"application/json; charset=utf-8",url:json_datafile,dataType:'json',async:true,success:function(data){var $thead=self.$element.find('thead');var $tbody=$('<tbody></tbody>');jQuery.each(data,function(key,val){var $row=$('<tr></tr>');if(val.hline){$row.attr('data-hline',true);}
...
if(meta.field!=null|| meta.rank){self.field_meta.push(meta);}});},getHeaderOptions:function(field){var self=this;var header=$(this.element).find('thead tr th[data-field="'+field+'"]').first();if(header.length){var header_options={field:field,rank:null,chartable:false,sortable:null,visible:null,beginatzero:null,align:null,tag:null,filter_control:null,text:header.text().trim(),title:this.cleanFieldValue(header.html()),chart_mode:null,value:{formatter:null,postfix:'',label:header.text().trim(),pad:''},dataset:{labels:[],colors:[]},axis:{},bar:{sort_order:'asc',xaxis:{},yaxis:{},horizontal_highlights:{label: {}},horizontal_line:{},horizontal_indicator_line:{},vertical_indicator_line:{},error_bar:{},tooltips:{},legend:{}},line:{fields:null,xaxis:{},yaxis: {},line:{},point:{},horizontal_highlights:{label:{}},legend:{}}};if(typeof $(header).data('rank')!=='undefined'){header_options.rank=$(header).data('rank');}
...
if(typeof header.data('bar-sort-field')!=='undefined'){header_options.bar.sort_field=header.data('bar-sort-field');}
if(typeof header.data('bar-sort-order')!=='undefined'){header_options.bar.sort_order=header.data('bar-sort-order');}
if(typeof header.data('bar-show-xaxis')!=='undefined'){header_options.bar.xaxis.display=header.data('bar-show-xaxis');}
if(typeof header.data('bar-show-yaxis')!=='undefined'){header_options.bar.yaxis.display=header.data('bar-show-yaxis');}
if(typeof header.data('bar-yaxis-gridlines')!=='undefined'){header_options.bar.yaxis.gridlines=header.data('bar-yaxis-gridlines');}
if(typeof header.data('bar-horizontal-highlights')!=='undefined'){header_options.bar.horizontal_highlights.data=this.parseDataList(header.data('bar-horizontal-highlights'));if(header_options.bar.horizontal_highlights.data.length==0&&header_options.bar.horizontal_highlights.enabled){header_options.bar.horizontal_highlights.enabled=false;}}
if(typeof header.data('bar-horizontal-highlight-opacity')!=='undefined'){header_options.bar.horizontal_highlights.opacity=header.data('bar-horizontal-highlight-opacity');}
if(typeof header.data('bar-horizontal-highlight-linewidth')!=='undefined'){header_options.bar.horizontal_highlights.lineWidth=header.data('bar-horizontal-highlight-width');}
if(typeof header.data('bar-horizontal-highlight-stroke')!=='undefined'){header_options.bar.horizontal_highlights.strokeStyle=header.data('bar-horizontal-highlight-stroke');}
if(typeof header.data('bar-horizontal-highlight-label-position')!=='undefined'){header_options.bar.horizontal_highlights.label.position=header.data('bar-horizontal-highlight-label-position');}
if(typeof header.data('bar-horizontal-highlight-label-fill')!=='undefined'){header_options.bar.horizontal_highlights.label.fillStyle=header.data('bar-horizontal-highlight-label-fill');}
if(typeof header.data('bar-horizontal-highlight-label-size')!=='undefined'){header_options.bar.horizontal_highlights.label.fontSize=header.data('bar-horizontal-highlight-label-size');}
if(typeof header.data('bar-horizontal-highlight-label-opacity')!=='undefined'){header_options.bar.horizontal_highlights.label.opacity=header.data('bar-horizontal-highlight-label-opacity');}
if(typeof header.data('bar-show-vertical-indicator')!=='undefined'){header_options.bar.vertical_indicator_line.enabled=header.data('bar-show-vertical-indicator');}
if(typeof header.data('bar-vertical-indicator-linewidth')!=='undefined'){header_options.bar.vertical_indicator_line.lineWidth=header.data('bar-vertical-indicator-width');}
if(typeof header.data('bar-vertical-indicator-stroke')!=='undefined'){header_options.bar.vertical_indicator_line.strokeStyle=header.data('bar-vertical-indicator-stroke');}
if(typeof header.data('bar-show-horizontal-indicator')!=='undefined'){header_options.bar.horizontal_indicator_line.enabled=header.data('bar-show-horizontal-indicator');}
if(typeof header.data('bar-horizontal-indicator-linewidth')!=='undefined'){header_options.bar.horizontal_indicator_line.lineWidth=header.data('bar-horizontal-indicator-width');}
if(typeof header.data('bar-horizontal-indicator-stroke')!=='undefined'){header_options.bar.horizontal_indicator_line.strokeStyle=header.data('bar-horizontal-indicator-stroke');}
if(typeof header.data('bar-horizontal-indicator-fill')!=='undefined'){header_options.bar.horizontal_indicator_line.fillStyle=header.data('bar-horizontal-indicator-fill');}
if(typeof header.data('bar-show-error-bar')!=='undefined'){header_options.bar.error_bar.enabled=header.data('bar-show-error-bar');}
if(typeof header.data('bar-error-bar-linewidth')!=='undefined'){header_options.bar.error_bar.lineWidth=header.data('bar-error-bar-linewidth');}
if(typeof header.data('bar-error-bar-tipwidth')!=='undefined'){header_options.bar.error_bar.tipWidth=header.data('bar-error-bar-tipwidth');}
if(typeof header.data('bar-error-bar-stroke')!=='undefined'){header_options.bar.error_bar.strokeStyle=header.data('bar-error-bar-stroke');}
if(typeof header.data('bar-tooltip-position')!=='undefined'){header_options.bar.tooltips.position=header.data('bar-tooltip-position');}
if(typeof header.data('bar-show-legend')!=='undefined'){header_options.bar.legend.enabled=header.data('bar-show-legend');}
if(typeof header.data('bar-legend-position')!=='undefined'){header_options.bar.legend.position=header.data('bar-legend-position');}
if(typeof header.data('line-extra-fields')!=='undefined'){header_options.line.fields=header.data('line-extra-fields').split(',').map(function(item){return item.trim();});header_options.line.fields.unshift(header_options.field);}
if(typeof header.data('line-show-xaxis')!=='undefined'){header_options.line.xaxis.display=header.data('line-show-xaxis');}
if(typeof header.data('line-xaxis-field')!=='undefined'){header_options.line.xaxis.field=header.data('line-xaxis-field');}
if(typeof header.data('line-xaxis-sorted')!=='undefined'){header_options.line.xaxis.sorted=header.data('line-xaxis-sorted');}
if(typeof header.data('line-xaxis-timeunit')!=='undefined'){header_options.line.xaxis.timeunit=header.data('line-xaxis-timeunit');}
if(typeof header.data('line-xaxis-timestepsize')!=='undefined'){header_options.line.xaxis.timestepsize=header.data('line-xaxis-timestepsize');}
if(typeof header.data('line-xaxis-gridlines')!=='undefined'){header_options.line.xaxis.gridlines=header.data('line-xaxis-gridlines');}
if(typeof header.data('line-yaxis-beginatzero')!=='undefined'){header_options.line.yaxis.beginatzero=header.data('line-yaxis-beginatzero');}
if(typeof header.data('line-yaxis-label')!=='undefined'){header_options.line.yaxis.label=header.data('line-yaxis-label');}
if(typeof header.data('line-yaxis-scale')!=='undefined'){header_options.line.yaxis.scale=header.data('line-yaxis-scale');}
if(typeof header.data('line-yaxis-gridlines')!=='undefined'){header_options.line.yaxis.gridlines=header.data('line-yaxis-gridlines');}
if(typeof header.data('line-height')!=='undefined'){header_options.line.height=header.data('line-height');}
if(typeof header.data('line-show-point')!=='undefined'){header_options.line.point.enabled=header.data('line-show-point');}
if(typeof header.data('line-point-radius')!=='undefined'){header_options.line.point.radius.normal=header.data('line-point-radius');}
if(typeof header.data('line-point-radius-hover')!=='undefined'){header_options.line.point.radius.hover=header.data('line-point-radius-hover');}
if(typeof header.data('line-show-line')!=='undefined'){header_options.line.line.enabled=header.data('line-show-line');}
if(typeof header.data('line-show-vertical-indicator')!=='undefined'){header_options.line.vertical_indicator_line.enabled=header.data('line-show-vertical-indicator');}
if(typeof header.data('line-vertical-indicator-linewidth')!=='undefined'){header_options.line.vertical_indicator_line.lineWidth=header.data('line-vertical-indicator-width');}
if(typeof header.data('line-vertical-indicator-stroke')!=='undefined'){header_options.line.vertical_indicator_line.strokeStyle=header.data('line-vertical-indicator-stroke');}
if(typeof header.data('line-show-horizontal-indicator')!=='undefined'){header_options.line.horizontal_indicator_line.enabled=header.data('line-show-horizontal-indicator');}
if(typeof header.data('line-horizontal-indicator-linewidth')!=='undefined'){header_options.line.horizontal_indicator_line.lineWidth=header.data('line-horizontal-indicator-width');}
if(typeof header.data('line-horizontal-indicator-stroke')!=='undefined'){header_options.line.horizontal_indicator_line.strokeStyle=header.data('line-horizontal-indicator-stroke');}
if(typeof header.data('line-horizontal-indicator-fill')!=='undefined'){header_options.line.horizontal_indicator_line.fillStyle=header.data('line-horizontal-indicator-fill');}
if(typeof header.data('line-show-horizontal-highlights')!=='undefined'){header_options.line.horizontal_highlights.enabled=header.data('line-show-horizontal-highlights');}
if(typeof header.data('line-horizontal-highlights')!=='undefined'){header_options.line.horizontal_highlights.data=this.parseDataList(header.data('line-horizontal-highlights'));if(header_options.line.horizontal_highlights.data.length==0&&attributes.line.horizontal_highlights.enabled){header_options.line.horizontal_highlights.enabled=false;}}
if(typeof header.data('line-horizontal-highlight-opacity')!=='undefined'){header_options.line.horizontal_highlights.opacity=header.data('line-horizontal-highlight-opacity');}
if(typeof header.data('line-horizontal-highlight-linewidth')!=='undefined'){header_options.line.horizontal_highlights.lineWidth=header.data('line-horizontal-highlight-width');}
if(typeof header.data('line-horizontal-highlight-stroke')!=='undefined'){header_options.line.horizontal_highlights.strokeStyle=header.data('line-horizontal-highlight-stroke');}
if(typeof header.data('line-horizontal-highlight-label-position')!=='undefined'){header_options.line.horizontal_highlights.label.position=header.data('line-horizontal-highlight-label-position');}
if(typeof header.data('line-horizontal-highlight-label-fill')!=='undefined'){header_options.line.horizontal_highlights.label.fillStyle=header.data('line-horizontal-highlight-label-fill');}
if(typeof header.data('line-horizontal-highlight-label-size')!=='undefined'){header_options.line.horizontal_highlights.label.fontSize=header.data('line-horizontal-highlight-label-size');}
if(typeof header.data('line-horizontal-highlight-label-opacity')!=='undefined'){header_options.line.horizontal_highlights.label.opacity=header.data('line-horizontal-highlight-label-opacity');}
if(typeof header.data('line-show-vertical-segments')!=='undefined'){header_options.line.vertical_segments.enabled=header.data('line-show-vertical-segments');}
if(typeof header.data('line-vertical-segments')!=='undefined'){header_options.line.vertical_segments.data=this.parseSegmentList(header.data('line-vertical-segments'));if(header_options.line.vertical_segments.data.length==0&&attributes.line.vertical_segments.enabled){header_options.line.vertical_segments.enabled=false;}}
if(typeof header.data('line-vertical-segment-opacity')!=='undefined'){header_options.line.vertical_segments.opacity=header.data('line-vertical-segment-opacity');}
if(typeof header.data('line-vertical-segment-label-position')!=='undefined'){header_options.line.vertical_segments.label.position=header.data('line-vertical-segment-label-position');}
if(typeof header.data('line-vertical-segment-label-fill')!=='undefined'){header_options.line.vertical_segments.label.fillStyle=header.data('line-vertical-segment-label-fill');}
if(typeof header.data('line-vertical-segment-label-size')!=='undefined'){header_options.line.vertical_segments.label.fontSize=header.data('line-vertical-segment-label-size');}
if(typeof header.data('line-vertical-segment-label-opacity')!=='undefined'){header_options.line.vertical_segments.label.opacity=header.data('line-vertical-segment-label-opacity');}
if(typeof header.data('line-show-error-bar')!=='undefined'){header_options.line.error_bar.enabled=header.data('line-show-error-bar');}
if(typeof header.data('line-error-bar-linewidth')!=='undefined'){header_options.line.error_bar.lineWidth=header.data('line-error-bar-linewidth');}
if(typeof header.data('line-error-bar-tipwidth')!=='undefined'){header_options.line.error_bar.tipWidth=header.data('line-error-bar-tipwidth');}
if(typeof header.data('line-error-bar-stroke')!=='undefined'){header_options.line.error_bar.strokeStyle=header.data('line-error-bar-stroke');}
if(typeof header.data('line-show-interval')!=='undefined'){header_options.line.interval.enabled=header.data('line-show-interval');}
if(typeof header.data('line-interval-linewidth')!=='undefined'){header_options.line.interval.lineWidth=header.data('line-interval-linewidth');}
if(typeof header.data('line-hline')!=='undefined'){header_options.line.horizontal_line.enabled=header.data('line-hline');}
if(typeof header.data('line-tooltip-position')!=='undefined'){header_options.line.tooltips.position=header.data('line-tooltip-position');}
if(typeof header.data('line-show-legend')!=='undefined'){header_options.line.legend.enabled=header.data('line-show-legend');}
if(typeof header.data('line-legend-position')!=='undefined'){header_options.line.legend.position=header.data('line-legend-position');}
if(header_options.value.formatter&&header_options.value.formatter.startsWith('valueFormatter_inline_bar_')){header_options.value.formatter='valueFormatter_float1_percentage';header_options.value.pad=' '.repeat(6);}
return header_options;}else{return{}}},updateTableVisibility:function(mode){if(mode=='show'){$(this.$element[0].closest('.fixed-table-container')).show(this.options.animation.show_speed);}else if(mode=='hide'){$(this.$element[0].closest('.fixed-table-container')).hide(this.options.animation.show_speed);}},updateVisualizationVisibility:function(mode){if(mode==='off'){if(this.options.chart_modes.indexOf('bar')>-1){this.hideBarChart();}
...
if(this.options.chart_modes.indexOf('line')>-1){this.hideLineChart();}
if(this.options.chart_modes.indexOf('scatter')>-1){this.hideScatterChart();}
this.showComparisonChart();}},updateChart:function(){if(this.options.show_chart){if(this.chart_mode=='off'){}else if(this.chart_mode=='bar'){this.updateBar();}else if(this.chart_mode=='line'){this.updateLine();}else if(this.chart_mode=='scatter'){this.updateScatter();}else if(this.chart_mode=='comparison'){this.updateComparison();}}},validBar:function(){var table_options=$(this.element).bootstrapTable('getOptions');var header_options=this.getHeaderOptions(table_options.sortName);return $(this.element).bootstrapTable('getData').length>0&&header_options.chartable;},updateBar:function(){var self=this;var table_options=this.$element.bootstrapTable('getOptions');var header_options=this.getHeaderOptions(table_options.sortName);var options=jQuery.extend(true,{},this.options);options.bar=jQuery.extend(true,{},options.bar,header_options.bar);if(this.bar_chart){this.bar_chart.destroy();}
var chart_ctx=document.getElementById(this.options.element.bar.canvas.replace('#',''));chart_ctx.width=$(this.options.element.bar.div).innerWidth();chart_ctx.height=options.bar.height;var table_data=this.$element.bootstrapTable('getData');var sort_name=table_options.sortName;var id_field=table_options.idField;var header=this.$element.find('thead tr th[data-field=\"'+sort_name+'\"]');if(header_options.bar.sort_field){table_data.sort(function(a,b){return self.valueSorter(a[header_options.bar.sort_field],b[header_options.bar.sort_field],header_options.bar.sort_order);});}
var datasets=[];var labels=[];for(var row_id=0;row_id<table_data.length;row_id++){var label=$("<div/>").html(table_data[row_id][options.table.id_field]).text().trim().replace(/<(?:.|\n)*?>/gm,'').replace('_',' ');if(labels.indexOf(label)>-1){var num_of_occurances=0;for(var label_id=0;row_id<labels.length;row_id++){if(labels[label_id]===label)
num_of_occurances++;}
label=label+new Array(num_of_occurances+1).join(' ');}
labels.push(label);}
var stacked_chart=false;var stacked_items=1;for(var row_id=0;row_id<table_data.length;row_id++){var values=self.parseDataList(table_data[row_id][sort_name]);if(values.length>1){stacked_chart=true;if(values.length>stacked_items){stacked_items=values.length;}}}
if(stacked_chart){if(header_options.dataset.labels.length==0){header_options.dataset.labels=new Array(stacked_items);for(var row_id=0;row_id<table_data.length;row_id++){var values=self.parseDataList(table_data[row_id][sort_name]);for(var value_id=0;value_id<values.length;value_id++){if(values[value_id].label){header_options.dataset.labels[value_id]=values[value_id].label;}}}}
for(var dataset_id=0;dataset_id<stacked_items;dataset_id++){var dataset={label:header_options.dataset.labels[dataset_id],data:[],data_min:[],data_max:[],data_string:[],data_uniqueid:[],backgroundColor:[],borderColor:[],borderWidth:2,hoverBackgroundColor:[],hoverBorderColor:[]};var all_value_min=Infinity;var all_value_max=-Infinity;for(var row_id=0;row_id<table_data.length;row_id++){var values=self.parseDataList(table_data[row_id][sort_name]);var value_sum=0;for(var ii=0;ii<values.length;ii++){value_sum+=values[ii]['y_value'];}
...
datasets.push(dataset);}}else{var dataset={label:sort_name,data:[],data_min:[],data_max:[],data_string:[],data_uniqueid:[],horizontal_line_value:[],horizontal_line_color:[],backgroundColor:[],borderColor:[],borderWidth:2,hoverBackgroundColor:[],hoverBorderColor:[]};var all_value_min=Infinity;var all_value_max=-Infinity;for(var row_id=0;row_id<table_data.length;row_id++){var item=self.parseNumericValue(table_data[row_id][sort_name]);dataset.data.push(item.value);if(header_options.value.formatter){dataset.data_string.push(this.stripHTML(window[header_options.value.formatter](table_data[row_id][sort_name])));}else{dataset.data_string.push(this.injectValuePostfix(table_data[row_id][sort_name],header_options.value.postfix));}
dataset.data_uniqueid.push(table_data[row_id][table_options.idField]);var value_max=item.value_max;var value_min=item.value_min;if(all_value_max<item.value){all_value_max=item.value;}
if(all_value_min>item.value){all_value_min=item.value;}
if(value_min!==null&&value_max!==null){if(value_max<value_min){var value_tmp=value_min;var value_min=value_max;var value_max=value_tmp;}
if(all_value_max<value_max){all_value_max=value_max;}
...
this.bar_chart=new Chart(chart_ctx,{type:'barError',data:chart_data,options:chart_options});}else{if($(this.options.element.bar.div).is(":visible")){$(this.options.element.bar.div).hide(0);}}},showBarChart:function(){var self=this;if(this.validBar()){if($(this.options.element.bar.div).is(":hidden")){$(this.options.element.bar.div).show(this.options.animation.show_speed,function(){self.updateBar();});}}},hideBarChart:function(){if($(this.options.element.bar.div).is(":visible")){$(this.options.element.bar.div).hide(this.options.animation.hide_speed,function(){});}},validLine:function(){var table_options=$(this.element).bootstrapTable('getOptions');var header_options=this.getHeaderOptions(table_options.sortName);var options=jQuery.extend(true,{},this.options);options.line=jQuery.extend(true,{},options.line,header_options.line);if(!options.line.fields){options.line.fields=[header_options.field];}
...
var dataset={label:current_header_options.title,value_postfix:current_header_options.value.postfix,data:[],data_uniqueid:[],data_min:[],data_max:[],data_string:[],horizontal_line_value:[],borderWidth:2,borderColor:this.colorCode(options.line.colors.datasets[dataset_id]),lineTension:0,spanGaps:true,fill:options.line.fill,backgroundColor:this.colorCode(options.line.colors.datasets[dataset_id],0.10),pointRadius:[],pointHoverRadius:[],pointBorderColor:[],pointHoverBorderColor:[],pointBackgroundColor:[],pointHoverBackgroundColor:[]};for(var row_id=0;row_id<table_data.length;row_id++){if(current_header_options.value.formatter){dataset.data_string.push(self.stripHTML(window[current_header_options.value.formatter](table_data[row_id][current_header_options.field])));}else{dataset.data_string.push(self.injectValuePostfix(table_data[row_id][current_header_options.field],current_header_options.value.postfix));}
...
this.line_chart=new Chart(chart_ctx,{type:'line',data:chart_data,options:chart_options});this.line_chart_data=chart_data;}else{if($(this.options.element.line.div).is(":visible")){$(this.options.element.line.div).hide(0);}}},showLineChart:function(){var self=this;if(this.validLine()){if($(this.options.element.line.div).is(":hidden")){$(this.options.element.line.div).show(this.options.animation.show_speed,function(){self.updateLine();});}}},hideLineChart:function(){if($(this.options.element.line.div).is(":visible")){$(this.options.element.line.div).hide(this.options.animation.hide_speed,function(){});}},updateScatter:function(){var self=this;if(this.scatter_chart){this.scatter_chart.destroy();}
...
var chart_data={labels:labels,datasets:[{data:data,data_uniqueid:data_uniqueid,data_min:data_min,data_max:data_max,data_string:data_string,borderWidth:this.options.scatter.point.borderWidth,pointBackgroundColor:point_bg_colors,pointBorderWidth:point_border_colors,pointHoverBackgroundColor:point_bg_hover_colors,pointHoverBorderColor:point_border_hover_colors,pointRadius:point_radius,pointHoverRadius:point_hover_radius}]};this.scatter_chart=new Chart(chart_ctx,{type:'line',data:chart_data,options:chart_options});},showScatterChart:function(){var self=this;if($(this.options.element.scatter.div).is(":hidden")){$(this.options.element.scatter.div).show(this.options.animation.show_speed,function(){self.updateScatter();});}},hideScatterChart:function(){if($(this.options.element.scatter.div).is(":visible")){$(this.options.element.scatter.div).hide(this.options.animation.hide_speed,function(){});}},initComparison:function(){var table_data=$(this.element).bootstrapTable('getData');if(table_data.length>1&&this.comparison_init){for(var i=0;i<table_data.length;i++){var field=table_data[i][this.options.table.id_field].trim();var label=table_data[i][this.options.table.id_field].trim().replace('_',' ');var active='';var selected='0';if(field==this.options.comparison.a_row){active=' class="active" ';selected='1';$(this.options.element.comparison.selector_a_button).html(label+' '+this.options.icon.caret);}
...
return value.toLocaleString();},colorCode:function(color_code,opacity){if(typeof opacity==='undefined'){opacity=1.0;}
