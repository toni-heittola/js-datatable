...
var uniqueValues={};for(var i=0;i<z;i++){var fieldValue=data[i][field].trim();var $fieldValue=$(fieldValue);$fieldValue.find('.hidden').remove();var fieldValueArray=[];if($fieldValue.length){$fieldValue.each(function(index){fieldValueArray.push($(this).text().trim());});}else{var comma=fieldValue.split(',');comma.forEach(function(item){fieldValueArray.push(item.trim());});}
...
function valueFormatter_int_nonzero(value,row,index){return valueFormatter_generic_fixed(value,row,index,0,undefined,undefined,undefined,false,'');}
function valueFormatter_int_nonzero_dash(value,row,index){return valueFormatter_generic_fixed(value,row,index,0,undefined,undefined,undefined,false,'-');}
function valueFormatter_int_nonzero_dash_muted(value,row,index){return valueFormatter_generic_fixed(value,row,index,0,true,undefined,undefined,false,'-');}
function valueFormatter_float1_nonzero(value,row,index){return valueFormatter_generic_fixed(value,row,index,1,undefined,undefined,undefined,false,'');}
function valueFormatter_float1_nonzero_dash(value,row,index){return valueFormatter_generic_fixed(value,row,index,1,undefined,undefined,undefined,false,'-');}
function valueFormatter_float1_nonzero_dash_muted(value,row,index){return valueFormatter_generic_fixed(value,row,index,1,true,undefined,undefined,false,'-');}
function valueFormatter_float1_nonzero(value,row,index){return valueFormatter_generic_fixed(value,row,index,1,undefined,undefined,undefined,false,'');}
function valueFormatter_float1_nonzero_dash(value,row,index){return valueFormatter_generic_fixed(value,row,index,1,undefined,undefined,undefined,false,'-');}
function valueFormatter_float1_nonzero_dash_muted(value,row,index){return valueFormatter_generic_fixed(value,row,index,1,true,undefined,undefined,false,'-');}
function valueFormatter_float2_nonzero(value,row,index){return valueFormatter_generic_fixed(value,row,index,2,undefined,undefined,undefined,false,'');}
function valueFormatter_float2_nonzero_dash(value,row,index){return valueFormatter_generic_fixed(value,row,index,2,undefined,undefined,undefined,false,'-');}
function valueFormatter_float2_nonzero_dash_muted(value,row,index){return valueFormatter_generic_fixed(value,row,index,2,true,undefined,undefined,false,'-');}
function valueFormatter_float3_nonzero(value,row,index){return valueFormatter_generic_fixed(value,row,index,3,undefined,undefined,undefined,false,'');}
function valueFormatter_float3_nonzero_dash(value,row,index){return valueFormatter_generic_fixed(value,row,index,3,undefined,undefined,undefined,false,'-');}
function valueFormatter_float3_nonzero_dash_muted(value,row,index){return valueFormatter_generic_fixed(value,row,index,3,true,undefined,undefined,false,'-');}
function valueFormatter_float4_nonzero(value,row,index){return valueFormatter_generic_fixed(value,row,index,4,undefined,undefined,undefined,false,'');}
function valueFormatter_float4_nonzero_dash(value,row,index){return valueFormatter_generic_fixed(value,row,index,4,undefined,undefined,undefined,false,'-');}
function valueFormatter_float4_nonzero_dash_muted(value,row,index){return valueFormatter_generic_fixed(value,row,index,4,true,undefined,undefined,false,'-');}
...
return prefix+value+postfix;}else{return value;}}
function valueFormatter_int_exp(value,row,index){return valueFormatter_generic_exponential(value,row,index,0);}
