...
var key=$.isNumeric(that.header.fields[j])?parseInt(that.header.fields[j],10):that.header.fields[j];var column=that.columns[getFieldIndex(that.columns,key)];var value;if(typeof key==='string'){value=item;var props=key.split('.');for(var prop_index=0;prop_index<props.length;prop_index++){value=value[props[prop_index]].replace(/<(?:.|\n)*?>/gm,'');}
...
if(typeof $(element).data('column-hover')!=='undefined'){attributes.table.column_hover=$(element).data('column-hover');}
...
if(typeof $(element).data('chart-position')!=='undefined'){attributes.chart.position=$(element).data('chart-position');}
if(typeof $(element).data('bar-height')!=='undefined'){attributes.bar.height=$(element).data('bar-height');}
if(typeof $(element).data('bar-hline')!=='undefined'){attributes.bar.horizontal_line.enabled=$(element).data('bar-hline');}
if(typeof $(element).data('bar-show-xaxis')!=='undefined'){attributes.bar.show_xaxis=$(element).data('bar-show-xaxis');}
if(typeof $(element).data('bar-horizontal-highlights')!=='undefined'){attributes.bar.horizontal_highlights.data=this.parseDataList($(element).data('bar-horizontal-highlights'));if(attributes.bar.horizontal_highlights.data.length==0&&attributes.bar.horizontal_highlights.enabled){attributes.bar.horizontal_highlights.enabled=false;}}
if(typeof $(element).data('bar-horizontal-highlight-opacity')!=='undefined'){attributes.bar.horizontal_highlights.opacity=$(element).data('bar-horizontal-highlight-opacity');}
if(typeof $(element).data('bar-horizontal-highlight-linewidth')!=='undefined'){attributes.bar.horizontal_highlights.lineWidth=$(element).data('bar-horizontal-highlight-width');}
if(typeof $(element).data('bar-horizontal-highlight-stroke')!=='undefined'){attributes.bar.horizontal_highlights.strokeStyle=$(element).data('bar-horizontal-highlight-stroke');}
if(typeof $(element).data('bar-horizontal-highlight-label-position')!=='undefined'){attributes.bar.horizontal_highlights.label.position=$(element).data('bar-horizontal-highlight-label-position');}
if(typeof $(element).data('bar-horizontal-highlight-label-fill')!=='undefined'){attributes.bar.horizontal_highlights.label.fillStyle=$(element).data('bar-horizontal-highlight-label-fill');}
if(typeof $(element).data('bar-horizontal-highlight-label-size')!=='undefined'){attributes.bar.horizontal_highlights.label.fontSize=$(element).data('bar-horizontal-highlight-label-size');}
if(typeof $(element).data('bar-horizontal-highlight-label-opacity')!=='undefined'){attributes.bar.horizontal_highlights.label.opacity=$(element).data('bar-horizontal-highlight-label-opacity');}
if(typeof $(element).data('bar-show-vertical-indicator')!=='undefined'){attributes.bar.vertical_indicator_line.enabled=$(element).data('bar-show-vertical-indicator');}
if(typeof $(element).data('bar-vertical-indicator-linewidth')!=='undefined'){attributes.bar.vertical_indicator_line.lineWidth=$(element).data('bar-vertical-indicator-width');}
if(typeof $(element).data('bar-vertical-indicator-stroke')!=='undefined'){attributes.bar.vertical_indicator_line.strokeStyle=$(element).data('bar-vertical-indicator-stroke');}
if(typeof $(element).data('bar-show-horizontal-indicator')!=='undefined'){attributes.bar.horizontal_indicator_line.enabled=$(element).data('bar-show-horizontal-indicator');}
if(typeof $(element).data('bar-horizontal-indicator-linewidth')!=='undefined'){attributes.bar.horizontal_indicator_line.lineWidth=$(element).data('bar-horizontal-indicator-width');}
if(typeof $(element).data('bar-horizontal-indicator-stroke')!=='undefined'){attributes.bar.horizontal_indicator_line.strokeStyle=$(element).data('bar-horizontal-indicator-stroke');}
if(typeof $(element).data('bar-horizontal-indicator-fill')!=='undefined'){attributes.bar.horizontal_indicator_line.fillStyle=$(element).data('bar-horizontal-indicator-fill');}
if(typeof $(element).data('bar-show-error-bar')!=='undefined'){attributes.bar.error_bar.enabled=$(element).data('bar-show-error-bar');}
if(typeof $(element).data('bar-error-bar-linewidth')!=='undefined'){attributes.bar.error_bar.lineWidth=$(element).data('bar-error-bar-linewidth');}
if(typeof $(element).data('bar-error-bar-tipwidth')!=='undefined'){attributes.bar.error_bar.tipWidth=$(element).data('bar-error-bar-tipwidth');}
if(typeof $(element).data('bar-error-bar-stroke')!=='undefined'){attributes.bar.error_bar.strokeStyle=$(element).data('bar-error-bar-stroke');}
if(typeof $(element).data('bar-tooltip-position')!=='undefined'){attributes.bar.tooltips.position=$(element).data('bar-tooltip-position');}
if(typeof $(element).data('line-fields')!=='undefined'){attributes.line.fields=$(element).data('line-fields').split(',').map(function(item){return item.trim();});}
if(typeof $(element).data('line-fill')!=='undefined'){attributes.line.fill=$(element).data('line-fill');}
if(typeof $(element).data('line-show-xaxis')!=='undefined'){attributes.line.xaxis.display=$(element).data('line-show-xaxis');}
if(typeof $(element).data('line-xaxis-field')!=='undefined'){attributes.line.xaxis.field=$(element).data('line-xaxis-field');}
if(typeof $(element).data('line-xaxis-sorted')!=='undefined'){attributes.line.xaxis.sorted=$(element).data('line-xaxis-sorted');}
if(typeof $(element).data('line-xaxis-timeunit')!=='undefined'){attributes.line.xaxis.timeunit=$(element).data('line-xaxis-timeunit');}
if(typeof $(element).data('line-xaxis-timestepsize')!=='undefined'){attributes.line.xaxis.timestepsize=$(element).data('line-xaxis-timestepsize');}
if(typeof $(element).data('line-xaxis-gridlines')!=='undefined'){attributes.line.xaxis.gridlines=$(element).data('line-xaxis-gridlines');}
if(typeof $(element).data('line-yaxis-beginatzero')!=='undefined'){attributes.line.yaxis.beginatzero=$(element).data('line-yaxis-beginatzero');}
if(typeof $(element).data('line-yaxis-label')!=='undefined'){attributes.line.yaxis.label=$(element).data('line-yaxis-label');}
if(typeof $(element).data('line-yaxis-scale')!=='undefined'){attributes.line.yaxis.scale=$(element).data('line-yaxis-scale');}
if(typeof $(element).data('line-yaxis-gridlines')!=='undefined'){attributes.line.yaxis.gridlines=$(element).data('line-yaxis-gridlines');}
if(typeof $(element).data('line-height')!=='undefined'){attributes.line.height=$(element).data('line-height');}
if(typeof $(element).data('line-show-point')!=='undefined'){attributes.line.point.enabled=$(element).data('line-show-point');}
if(typeof $(element).data('line-point-radius')!=='undefined'){attributes.line.point.radius.normal=$(element).data('line-point-radius');}
if(typeof $(element).data('line-point-radius-hover')!=='undefined'){attributes.line.point.radius.hover=$(element).data('line-point-radius-hover');}
if(typeof $(element).data('line-show-line')!=='undefined'){attributes.line.line.enabled=$(element).data('line-show-line');}
if(typeof $(element).data('line-show-vertical-indicator')!=='undefined'){attributes.line.vertical_indicator_line.enabled=$(element).data('line-show-vertical-indicator');}
if(typeof $(element).data('line-vertical-indicator-linewidth')!=='undefined'){attributes.line.vertical_indicator_line.lineWidth=$(element).data('line-vertical-indicator-width');}
if(typeof $(element).data('line-vertical-indicator-stroke')!=='undefined'){attributes.line.vertical_indicator_line.strokeStyle=$(element).data('line-vertical-indicator-stroke');}
if(typeof $(element).data('line-show-horizontal-indicator')!=='undefined'){attributes.line.horizontal_indicator_line.enabled=$(element).data('line-show-horizontal-indicator');}
if(typeof $(element).data('line-horizontal-indicator-linewidth')!=='undefined'){attributes.line.horizontal_indicator_line.lineWidth=$(element).data('line-horizontal-indicator-width');}
if(typeof $(element).data('line-horizontal-indicator-stroke')!=='undefined'){attributes.line.horizontal_indicator_line.strokeStyle=$(element).data('line-horizontal-indicator-stroke');}
if(typeof $(element).data('line-horizontal-indicator-fill')!=='undefined'){attributes.line.horizontal_indicator_line.fillStyle=$(element).data('line-horizontal-indicator-fill');}
if(typeof $(element).data('line-show-horizontal-highlights')!=='undefined'){attributes.line.horizontal_highlights.enabled=$(element).data('line-show-horizontal-highlights');}
if(typeof $(element).data('line-horizontal-highlights')!=='undefined'){attributes.line.horizontal_highlights.data=this.parseDataList($(element).data('line-horizontal-highlights'));if(attributes.line.horizontal_highlights.data.length==0&&attributes.line.horizontal_highlights.enabled){attributes.line.horizontal_highlights.enabled=false;}}
if(typeof $(element).data('line-horizontal-highlight-opacity')!=='undefined'){attributes.line.horizontal_highlights.opacity=$(element).data('line-horizontal-highlight-opacity');}
if(typeof $(element).data('line-horizontal-highlight-linewidth')!=='undefined'){attributes.line.horizontal_highlights.lineWidth=$(element).data('line-horizontal-highlight-width');}
if(typeof $(element).data('line-horizontal-highlight-stroke')!=='undefined'){attributes.line.horizontal_highlights.strokeStyle=$(element).data('line-horizontal-highlight-stroke');}
if(typeof $(element).data('line-horizontal-highlight-label-position')!=='undefined'){attributes.line.horizontal_highlights.label.position=$(element).data('line-horizontal-highlight-label-position');}
if(typeof $(element).data('line-horizontal-highlight-label-fill')!=='undefined'){attributes.line.horizontal_highlights.label.fillStyle=$(element).data('line-horizontal-highlight-label-fill');}
if(typeof $(element).data('line-horizontal-highlight-label-size')!=='undefined'){attributes.line.horizontal_highlights.label.fontSize=$(element).data('line-horizontal-highlight-label-size');}
if(typeof $(element).data('line-horizontal-highlight-label-opacity')!=='undefined'){attributes.line.horizontal_highlights.label.opacity=$(element).data('line-horizontal-highlight-label-opacity');}
if(typeof $(element).data('line-show-vertical-segments')!=='undefined'){attributes.line.vertical_segments.enabled=$(element).data('line-show-vertical-segments');}
if(typeof $(element).data('line-vertical-segments')!=='undefined'){attributes.line.vertical_segments.data=this.parseSegmentList($(element).data('line-vertical-segments'));if(attributes.line.vertical_segments.data.length==0&&attributes.line.vertical_segments.enabled){attributes.line.vertical_segments.enabled=false;}}
if(typeof $(element).data('line-vertical-segment-opacity')!=='undefined'){attributes.line.vertical_segments.opacity=$(element).data('line-vertical-segment-opacity');}
if(typeof $(element).data('line-vertical-segment-label-position')!=='undefined'){attributes.line.vertical_segments.label.position=$(element).data('line-vertical-segment-label-position');}
if(typeof $(element).data('line-vertical-segment-label-fill')!=='undefined'){attributes.line.vertical_segments.label.fillStyle=$(element).data('line-vertical-segment-label-fill');}
if(typeof $(element).data('line-vertical-segment-label-size')!=='undefined'){attributes.line.vertical_segments.label.fontSize=$(element).data('line-vertical-segment-label-size');}
if(typeof $(element).data('line-vertical-segment-label-opacity')!=='undefined'){attributes.line.vertical_segments.label.opacity=$(element).data('line-vertical-segment-label-opacity');}
if(typeof $(element).data('line-show-error-bar')!=='undefined'){attributes.line.error_bar.enabled=$(element).data('line-show-error-bar');}
if(typeof $(element).data('line-error-bar-linewidth')!=='undefined'){attributes.line.error_bar.lineWidth=$(element).data('line-error-bar-linewidth');}
if(typeof $(element).data('line-error-bar-tipwidth')!=='undefined'){attributes.line.error_bar.tipWidth=$(element).data('line-error-bar-tipwidth');}
if(typeof $(element).data('line-error-bar-stroke')!=='undefined'){attributes.line.error_bar.strokeStyle=$(element).data('line-error-bar-stroke');}
if(typeof $(element).data('line-show-interval')!=='undefined'){attributes.line.interval.enabled=$(element).data('line-show-interval');}
if(typeof $(element).data('line-interval-linewidth')!=='undefined'){attributes.line.interval.lineWidth=$(element).data('line-interval-linewidth');}
if(typeof $(element).data('line-hline')!=='undefined'){attributes.line.horizontal_line.enabled=$(element).data('line-hline');}
if(typeof $(element).data('line-tooltip-position')!=='undefined'){attributes.line.tooltips.position=$(element).data('line-tooltip-position');}
if(typeof $(element).data('line-show-legend')!=='undefined'){attributes.line.legend.enabled=$(element).data('line-show-legend');}
if(typeof $(element).data('line-legend-position')!=='undefined'){attributes.line.legend.position=$(element).data('line-legend-position');}
...
if(typeof $(element).data('scatter-point-radius')!=='undefined'){attributes.scatter.point.normal=$(element).data('scatter-point-radius');}
if(typeof $(element).data('scatter-point-radius-hover')!=='undefined'){attributes.scatter.point.hover=$(element).data('scatter-point-radius-hover');}
if(typeof $(element).data('scatter-show-vertical-indicator')!=='undefined'){attributes.scatter.vertical_indicator_line.enabled=$(element).data('scatter-show-vertical-indicator');}
if(typeof $(element).data('scatter-vertical-indicator-linewidth')!=='undefined'){attributes.scatter.vertical_indicator_line.lineWidth=$(element).data('scatter-vertical-indicator-width');}
if(typeof $(element).data('scatter-vertical-indicator-stroke')!=='undefined'){attributes.scatter.vertical_indicator_line.strokeStyle=$(element).data('scatter-vertical-indicator-stroke');}
if(typeof $(element).data('scatter-show-horizontal-indicator')!=='undefined'){attributes.scatter.horizontal_indicator_line.enabled=$(element).data('scatter-show-horizontal-indicator');}
if(typeof $(element).data('scatter-horizontal-indicator-linewidth')!=='undefined'){attributes.scatter.horizontal_indicator_line.lineWidth=$(element).data('scatter-horizontal-indicator-width');}
if(typeof $(element).data('scatter-horizontal-indicator-stroke')!=='undefined'){attributes.scatter.horizontal_indicator_line.strokeStyle=$(element).data('scatter-horizontal-indicator-stroke');}
if(typeof $(element).data('scatter-horizontal-indicator-fill')!=='undefined'){attributes.scatter.horizontal_indicator_line.fillStyle=$(element).data('scatter-horizontal-indicator-fill');}
if(typeof $(element).data('scatter-show-error-bar')!=='undefined'){attributes.scatter.error_bar.enabled=$(element).data('line-show-error-bar');}
if(typeof $(element).data('scatter-error-bar-linewidth')!=='undefined'){attributes.scatter.error_bar.lineWidth=$(element).data('scatter-error-bar-linewidth');}
if(typeof $(element).data('scatter-error-bar-tipwidth')!=='undefined'){attributes.scatter.error_bar.tipWidth=$(element).data('scatter-error-bar-tipwidth');}
if(typeof $(element).data('scatter-error-bar-stroke')!=='undefined'){attributes.scatter.error_bar.strokeStyle=$(element).data('scatter-error-bar-stroke');}
if(typeof $(element).data('scatter-show-error-box')!=='undefined'){attributes.scatter.error_bar.bounding_box=$(element).data('line-show-error-box');}
if(typeof $(element).data('scatter-error-box-fill')!=='undefined'){attributes.scatter.error_bar.fillStyle=$(element).data('scatter-error-box-fill');}
...
if(typeof $(element).data('comparison-show-error-bar')!=='undefined'){attributes.comparison.error_bar.enabled=$(element).data('comparison-show-error-bar');}
if(typeof $(element).data('comparison-error-bar-linewidth')!=='undefined'){attributes.comparison.error_bar.lineWidth=$(element).data('comparison-error-bar-linewidth');}
if(typeof $(element).data('comparison-error-bar-tipwidth')!=='undefined'){attributes.comparison.error_bar.tipWidth=$(element).data('comparison-error-bar-tipwidth');}
if(typeof $(element).data('comparison-error-bar-stroke')!=='undefined'){attributes.comparison.error_bar.strokeStyle=$(element).data('comparison-error-bar-stroke');}
...
if(typeof $(element).data('show-pagination-switch')==='undefined'){if(this.options.show_toolbar){$(this.element).attr('data-show-pagination-switch',this.options.table.show_pagination_switch);}else{$(this.element).attr('data-show-pagination-switch',false);}}
...
if(!this.options.show_toolbar&&this.options.table_default_mode==='hide'){$(this.element).attr('data-height',1);$(this.element).attr('data-page-size',1);$(this.element).attr('data-pagination',false);$(this.element).attr('data-show-pagination-switch',false);}
this.rank_init=true;this.comparison_init=true;this.table_rank=[];this.chart_update=false;this.chart_init=true;this.bar_chart=null;this.scatter_chart=null;this.comparison_chart=null;this.line_chart=null;this.line_chart_data=null;this.chart_mode=this.options.chart_default_mode;this.table_mode=this.options.table_default_mode;this.hline_value=[];this.hline_index=[];this.hline_color=[];this.field_meta=[];var self=this;this.log(this.name+'::init');if(typeof $(this.element).data('id-field')!=='undefined'){$(this.element).data('unique-id',$(this.element).data('id-field'));}
...
$(this.element).find('thead tr th[data-sortable="true"]').each(function(){window['valueSorter'+this.uniqueId]=function(a,b){return self.valueSorter(a,b,'asc');};$(this).attr('data-sorter','valueSorter'+this.uniqueId);});$(this.element).find('thead tr th[data-reversed="true"]').each(function(){window['valueSorterReverse'+this.uniqueId]=function(a,b){return self.valueSorter(a,b,'desc');};$(this).attr('data-sorter','valueSorterReverse'+this.uniqueId);});$(this.element).find('thead tr th[data-chartable="true"]').each(function(){$(this).append(' '+self.options.icon.chartable);});$(this.element).find('thead tr th[data-value-type]').each(function(){var value_type=$(this).data('value-type');if(value_type.includes('percentage')){$(this).attr('data-postfix','%');}
switch(value_type){case'int':$(this).attr('data-formatter','valueFormatter_int');break;case'float1':$(this).attr('data-formatter','valueFormatter_float1');break;case'float2':$(this).attr('data-formatter','valueFormatter_float2');break;case'float3':$(this).attr('data-formatter','valueFormatter_float3');break;case'float4':$(this).attr('data-formatter','valueFormatter_float4');break;case'float1-exp':$(this).attr('data-formatter','valueFormatter_float1_exp');break;case'float2-exp':$(this).attr('data-formatter','valueFormatter_float2_exp');break;case'float3-exp':$(this).attr('data-formatter','valueFormatter_float3_exp');break;case'float4-exp':$(this).attr('data-formatter','valueFormatter_float4_exp');break;case'numeric-unit':window['valueFormatter_numeric_unit'+this.uniqueId]=function(value,row,index){if($.isNumeric(value)){value=parseFloat(value);return self.addNumberPrefix(value);}else{return value;}};$(this).attr('data-formatter','valueFormatter_numeric_unit'+this.uniqueId);break;case'int-interval':$(this).attr('data-formatter','valueFormatter_int_with_interval');break;case'int-interval-muted':$(this).attr('data-formatter','valueFormatter_int_with_interval_muted');break;case'float1-interval':$(this).attr('data-formatter','valueFormatter_float1_with_interval');break;case'float1-interval-muted':$(this).attr('data-formatter','valueFormatter_float1_with_interval_muted');break;case'float2-interval':$(this).attr('data-formatter','valueFormatter_float2_with_interval');break;case'float2-interval-muted':$(this).attr('data-formatter','valueFormatter_float2_with_interval_muted');break;case'float3-interval':$(this).attr('data-formatter','valueFormatter_float3_with_interval');break;case'float3-interval-muted':$(this).attr('data-formatter','valueFormatter_float3_with_interval_muted');break;case'float4-interval':$(this).attr('data-formatter','valueFormatter_float4_with_interval');break;case'float4-interval-muted':$(this).attr('data-formatter','valueFormatter_float4_with_interval_muted');break;case'int-plusminus':$(this).attr('data-formatter','valueFormatter_int_plusminus');break;case'int-plusminus-muted':$(this).attr('data-formatter','valueFormatter_int_plusminus_muted');break;case'float1-plusminus':$(this).attr('data-formatter','valueFormatter_float1_plusminus');break;case'float1-plusminus-muted':$(this).attr('data-formatter','valueFormatter_float1_plusminus_muted');break;case'float2-plusminus':$(this).attr('data-formatter','valueFormatter_float2_plusminus');break;case'float2-plusminus-muted':$(this).attr('data-formatter','valueFormatter_float2_plusminus_muted');break;case'float3-plusminus':$(this).attr('data-formatter','valueFormatter_float3_plusminus');break;case'float3-plusminus-muted':$(this).attr('data-formatter','valueFormatter_float3_plusminus_muted');break;case'float4-plusminus':$(this).attr('data-formatter','valueFormatter_float4_plusminus');break;case'float4-plusminus-muted':$(this).attr('data-formatter','valueFormatter_float4_plusminus_muted');break;case'int-percentage':$(this).attr('data-formatter','valueFormatter_int_percentage');break;case'float1-percentage':$(this).attr('data-formatter','valueFormatter_float1_percentage');break;case'float2-percentage':$(this).attr('data-formatter','valueFormatter_float2_percentage');break;case'float3-percentage':$(this).attr('data-formatter','valueFormatter_float3_percentage');break;case'float4-percentage':$(this).attr('data-formatter','valueFormatter_float4_percentage');break;case'int-percentage-interval':$(this).attr('data-formatter','valueFormatter_int_percentage_with_interval');break;case'int-percentage-interval-muted':$(this).attr('data-formatter','valueFormatter_int_percentage_with_interval_muted');break;case'float1-percentage-interval':$(this).attr('data-formatter','valueFormatter_float1_percentage_with_interval');break;case'float1-percentage-interval-muted':$(this).attr('data-formatter','valueFormatter_float1_percentage_with_interval_muted');break;case'float2-percentage-interval':$(this).attr('data-formatter','valueFormatter_float2_percentage_with_interval');break;case'float2-percentage-interval-muted':$(this).attr('data-formatter','valueFormatter_float2_percentage_with_interval_muted');break;case'float3-percentage-interval':$(this).attr('data-formatter','valueFormatter_float3_percentage_with_interval');break;case'float3-percentage-interval-muted':$(this).attr('data-formatter','valueFormatter_float3_percentage_with_interval_muted');break;case'float4-percentage-interval':$(this).attr('data-formatter','valueFormatter_float4_percentage_with_interval');break;case'float4-percentage-interval-muted':$(this).attr('data-formatter','valueFormatter_float4_percentage_with_interval_muted');break;case'int-percentage-plusminus':$(this).attr('data-formatter','valueFormatter_int_percentage_plusminus');break;case'int-percentage-plusminus-muted':$(this).attr('data-formatter','valueFormatter_int_percentage_plusminus_muted');break;case'float1-percentage-plusminus':$(this).attr('data-formatter','valueFormatter_float1_percentage_plusminus');break;case'float1-percentage-plusminus-muted':$(this).attr('data-formatter','valueFormatter_float1_percentage_plusminus_muted');break;case'float2-percentage-plusminus':$(this).attr('data-formatter','valueFormatter_float2_percentage_plusminus');break;case'float2-percentage-plusminus-muted':$(this).attr('data-formatter','valueFormatter_float2_percentage_plusminus_muted');break;case'float3-percentage-plusminus':$(this).attr('data-formatter','valueFormatter_float3_percentage_plusminus');break;case'float3-percentage-plusminus-muted':$(this).attr('data-formatter','valueFormatter_float3_percentage_plusminus_muted');break;case'float4-percentage-plusminus':$(this).attr('data-formatter','valueFormatter_float4_percentage_plusminus');break;case'float4-percentage-plusminus-muted':$(this).attr('data-formatter','valueFormatter_float4_percentage_plusminus_muted');break;case'int-error':$(this).attr('data-formatter','valueFormatter_int_error');break;case'float1-error':$(this).attr('data-formatter','valueFormatter_float1_error');break;case'float2-error':$(this).attr('data-formatter','valueFormatter_float2_error');break;case'float3-error':$(this).attr('data-formatter','valueFormatter_float3_error');break;case'float4-error':$(this).attr('data-formatter','valueFormatter_float4_error');break;case'list':$(this).attr('data-formatter','valueFormatter_list');break;case'url':window['valueFormatter_url'+this.uniqueId]=function(value,row,index){var links=[];if(value.trim()){var items=value.split(',');if(items.length>0){for(var i=0;i<items.length;i++){var current_link=items[i].trim();var index=current_link.lastIndexOf(';');if(index!=-1){var link=current_link.substring(0,index);var link_title=current_link.substring(index+1);links.push('<a class="datatable-link" href="'+link+'">'+link_title+'</a>');}else{links.push('<a class="datatable-icon" href="'+current_link+'">'+self.options.icon.url+'</a>');}}}}
return links.join('<br>');};$(this).attr('data-formatter','valueFormatter_url'+this.uniqueId);break;case'ref':window['valueFormatter_ref'+this.uniqueId]=function(value,row,index){var links=[];if(value.trim()){var items=value.split(',');if(items.length>0){for(var i=0;i<items.length;i++){var current_link=items[i].trim();var index=current_link.lastIndexOf(';');if(index!=-1){var link=current_link.substring(0,index);var link_title=current_link.substring(index+1);links.push('<a class="datatable-link" href="'+link+'">['+link_title+']</a>');}else{links.push('<a class="datatable-icon" href="'+current_link+'">'+self.options.icon.ref+'</a>');}}}}
return links.join('<br>');};$(this).attr('data-formatter','valueFormatter_ref'+this.uniqueId);break;case'anchor':window['valueFormatter_anchor'+this.uniqueId]=function valueFormatter_anchor(value,row,index){if(value.trim()){return'<a class="datatable-icon" href="javascript:void(0)" onclick="$(\'#collapse-'+value+'\').collapse(\'show\');window.location.hash=\''+value+'\';return false;">'+self.options.icon.anchor+'</a>'}else{return value;}};$(this).attr('data-formatter','valueFormatter_anchor'+this.uniqueId);break;case'inline-bar-horizontal-percentage':window['valueFormatter_inline_bar_horizontal_percentage'+this.uniqueId]=function(value,row,index){var data=self.parseDataList(value);var html='';if(data.length>0){var value_sum=0;for(var i=0;i<data.length;i++){value_sum+=data[i]['y_value'];}
html+='<div class="progress datatable-horizontal-bar">';for(var i=0;i<data.length;i++){var percentage=data[i]['y_value'];if(value_sum>100){percentage=percentage/value_sum*100.0;}
var current_color=self.options.inline_chart.bar_horizontal.colors[i%4];if(data[i]['color']){var current_color=data[i]['color'];}
html+='<div class="progress-bar" role="progressbar" data-percentage="100" aria-valuenow="'+percentage+'" aria-valuemin="0" aria-valuemax="100" style="width: '+percentage+'%;background-color:'+current_color+'" ';if(data[i]['label']){html+='data-toggle="tooltip" data-placement="bottom" title="'+data[i]['label']+': <strong>'+data[i]['y_value']+'%</strong>" ';}else{html+='data-toggle="tooltip" data-placement="bottom" title="<strong>'+data[i]['y_value']+'%</strong>" ';}
html+='>';html+='</div>';}
html+='</div>';}
return html;};$(this).attr('data-formatter','valueFormatter_inline_bar_horizontal_percentage'+this.uniqueId);break;case'inline-bar-horizontal-thin-percentage':window['valueFormatter_inline_bar_horizontal_thin_percentage'+this.uniqueId]=function(value,row,index){var data=self.parseDataList(value);var html='';if(data.length>0){var value_sum=0;for(var i=0;i<data.length;i++){value_sum+=data[i]['y_value'];}
html+='<div class="progress datatable-horizontal-bar-thin">';for(var i=0;i<data.length;i++){var percentage=data[i]['y_value'];if(value_sum>100){percentage=percentage/value_sum*100.0;}
var current_color=self.options.inline_chart.bar_horizontal.colors[i%4];if(data[i]['color']){var current_color=data[i]['color'];}
html+='<div class="progress-bar" role="progressbar" data-percentage="100" aria-valuenow="'+percentage+'" aria-valuemin="0" aria-valuemax="100" style="width: '+percentage+'%;background-color:'+current_color+'" ';if(data[i]['label']){html+='data-toggle="tooltip" data-placement="bottom" title="'+data[i]['label']+': <strong>'+data[i]['y_value']+'%</strong>" ';}else{html+='data-toggle="tooltip" data-placement="bottom" title="<strong>'+data[i]['y_value']+'%</strong>" ';}
html+='>';html+='</div>';}
html+='</div>';}
return html;};$(this).attr('data-formatter','valueFormatter_inline_bar_horizontal_thin_percentage'+this.uniqueId);break;case'inline-bar-vertical':$(this).attr('data-formatter','valueFormatter_inline_bar_vertical');$(this).addClass('canvas-cell');break;case'inline-bar-vertical-tristate':$(this).attr('data-formatter','valueFormatter_inline_bar_vertical_tristate');$(this).addClass('canvas-cell');break;case'inline-line':$(this).attr('data-formatter','valueFormatter_inline_line');$(this).addClass('canvas-cell');break;case'inline-line-steps':$(this).attr('data-formatter','valueFormatter_inline_line_steps');$(this).addClass('canvas-cell');break;case'inline-pie':$(this).attr('data-formatter','valueFormatter_inline_pie');$(this).addClass('canvas-cell');break;case'inline-indicator-value':window['valueFormatter_inline_indicator_value_svg'+this.uniqueId]=function(value,row,index){var data=self.parseDataList(value);var html='';if(data.length>0){for(var i=0;i<data.length;i++){var fill_color='transparent';if(!!data[i]['color']){fill_color=data[i]['color'];}else{fill_color=self.options.inline_chart.value_indicator.color.default;}
...
return html;};$(this).attr('data-formatter','valueFormatter_inline_indicator_value_svg'+this.uniqueId);$(this).addClass('canvas-cell');break;case'inline-indicator-value-html':window['valueFormatter_inline_indicator_value_html'+this.uniqueId]=function(value,row,index){var data=self.parseDataList(value);var html='';if(data.length>0){html='<div class="">';for(var i=0;i<data.length;i++){var css_class=self.options.inline_chart.value_indicator.html.css;var fill_color='transparent';if(!!data[i]['color']){fill_color=data[i]['color'];}else{fill_color=self.options.inline_chart.value_indicator.color.default;}
...
html+='</div>';}
return html;};$(this).attr('data-formatter','valueFormatter_inline_indicator_value_html'+this.uniqueId);$(this).addClass('canvas-cell');break;case'inline-indicator-binary':window['valueFormatter_inline_indicator_binary_svg'+this.uniqueId]=function(value,row,index){var data=self.parseDataList(value);var html='';if(data.length>0){for(var i=0;i<data.length;i++){var fill_color=null;if(data[i]['y_value']>=self.options.inline_chart.value_indicator.data.binarizationThreshold){fill_color=self.options.inline_chart.value_indicator.color.positive;}else{fill_color=self.options.inline_chart.value_indicator.color.negative;}
html+=self.svgElement(self.options.inline_chart.value_indicator.svg.type,self.options.inline_chart.value_indicator.svg.size,fill_color,data[i]['label'],false,0);}}
return html;};$(this).attr('data-formatter','valueFormatter_inline_indicator_binary_svg'+this.uniqueId);$(this).addClass('canvas-cell');break;case'inline-indicator-binary-html':window['valueFormatter_inline_binary_html'+this.uniqueId]=function(value,row,index){var data=self.parseDataList(value);var html='';if(data.length>0){html='<div class="">';for(var i=0;i<data.length;i++){var css_class=self.options.inline_chart.value_indicator.html.css;var fill_color='transparent';if(data[i]['y_value']>self.options.inline_chart.value_indicator.data.binarizationThreshold){fill_color=self.options.inline_chart.value_indicator.color.positive;}else{fill_color=self.options.inline_chart.value_indicator.color.negative;}
html+='<span class="'+css_class+'" aria-hidden="true" ';if(data[i]['label']){html+='data-toggle="tooltip" data-placement="bottom" title="'+data[i]['label']+'"';}
html+=' style="color:'+fill_color+'"';html+='>';html+='</span>';}
html+='</div>';}
return html;};$(this).attr('data-formatter','valueFormatter_inline_binary_html'+this.uniqueId);$(this).addClass('canvas-cell');break;case'inline-indicator-tristate':window['valueFormatter_inline_indicator_tristate_svg'+this.uniqueId]=function(value,row,index){var data=self.parseDataList(value);var html='';if(data.length>0){for(var i=0;i<data.length;i++){var fill_color='transparent';var offset=0;if(data[i]['y_value']>self.options.inline_chart.value_indicator.data.binarizationThreshold){fill_color=self.options.inline_chart.value_indicator.color.positive;offset=0;}else if(data[i]['y_value']<self.options.inline_chart.value_indicator.data.binarizationThreshold){fill_color=self.options.inline_chart.value_indicator.color.negative;offset=self.options.inline_chart.value_indicator.svg.size;}else{fill_color=self.options.inline_chart.value_indicator.color.equal;offset=self.options.inline_chart.value_indicator.svg.size/2;}
...
return html;};$(this).attr('data-formatter','valueFormatter_inline_indicator_tristate_svg'+this.uniqueId);$(this).addClass('canvas-cell');break;case'inline-indicator-tristate-html':window['valueFormatter_inline_tristate_html'+this.uniqueId]=function(value,row,index){var data=self.parseDataList(value);var html='';if(data.length>0){html='<div class="">';for(var i=0;i<data.length;i++){var css_class=self.options.inline_chart.value_indicator.html.css;var fill_color='transparent';var offset=null;if(data[i]['y_value']>self.options.inline_chart.value_indicator.data.binarizationThreshold){fill_color=self.options.inline_chart.value_indicator.color.positive;offset=0;}else if(data[i]['y_value']<self.options.inline_chart.value_indicator.data.binarizationThreshold){fill_color=self.options.inline_chart.value_indicator.color.negative;offset=10;}else{fill_color=self.options.inline_chart.value_indicator.color.equal;offset=5;}
html+='<span class="'+css_class+'" aria-hidden="true" ';if(data[i]['label']){html+='data-toggle="tooltip" data-placement="bottom" title="'+data[i]['label']+'"';}
html+=' style="color:'+fill_color+'; height:30px;top:'+offset+'px;"';html+='>';html+='</span>';}
html+='</div>';}
return html;};$(this).attr('data-formatter','valueFormatter_inline_tristate_html'+this.uniqueId);$(this).addClass('canvas-cell');break;default:window['valueFormatter_hide'+this.uniqueId]=function(value,row,index){return'<div class="text-muted" data-value="'+value+'">Invalid data-value-type</div>';};$(this).attr('data-formatter','valueFormatter_hide'+this.uniqueId);break;}});var originalLineDraw=Chart.controllers.bar.prototype.draw;Chart.helpers.extend(Chart.controllers.bar.prototype,{draw:function(){originalLineDraw.apply(this,arguments);var chart=this.chart;var scale=this.scale;var ctx=chart.chart.ctx;var xaxis=chart.scales['x-axis-0'];var yaxis=chart.scales['y-axis-0'];if(chart.config.options.hasOwnProperty('horizontal_line')&&chart.config.options.horizontal_line.enabled){var horizontal_line_value=this.getDataset().horizontal_line_value;var horizontal_line_color=this.getDataset().horizontal_line_color;$.each(horizontal_line_value,function(index,value){var y=yaxis.getPixelForValue(value);ctx.save();ctx.beginPath();ctx.strokeStyle=horizontal_line_color[index];var lineWidth=2;if(chart.config.options.horizontal_line.hasOwnProperty('lineWidth')){lineWidth=chart.config.options.horizontal_line.lineWidth;}
...
$.each(values,function(index,value){var y=yaxis.getPixelForValue(value);ctx.save();ctx.beginPath();if(colors.length>index){ctx.strokeStyle=colors[index];}else{ctx.strokeStyle=colors[0];}
ctx.lineWidth=chart.config.data.hline.width;ctx.moveTo(xaxis.left,y);ctx.lineTo(xaxis.right,y);ctx.stroke();ctx.restore();});}
if(this.chart.tooltip._active&&this.chart.tooltip._active.length){var current_point=this.chart.tooltip._active[0],ctx=this.chart.ctx,x=current_point.tooltipPosition().x,topY=this.chart.scales['y-axis-0'].top,bottomY=this.chart.scales['y-axis-0'].bottom;ctx.save();ctx.beginPath();ctx.moveTo(x,topY);ctx.lineTo(x,bottomY);ctx.lineWidth=1;ctx.strokeStyle='#888';ctx.stroke();ctx.restore();}}});Chart.defaults.stripe=Chart.helpers.clone(Chart.defaults.line);Chart.controllers.stripe=Chart.controllers.line.extend({draw:function(ease){var result=Chart.controllers.line.prototype.draw.apply(this,arguments);var chart=this.chart;var scale=this.scale;var ctx=chart.chart.ctx;if(chart.config.options.hasOwnProperty('horizontal_line')&&chart.config.options.horizontal_line.enabled){var xaxis=chart.scales['x-axis-0'];var yaxis=chart.scales['y-axis-0'];var horizontal_line_value=this.getDataset().horizontal_line_value;if(horizontal_line_value.constructor!==Array){horizontal_line_value=[horizontal_line_value];}
$.each(horizontal_line_value,function(index,value){var y=yaxis.getPixelForValue(value);ctx.save();ctx.beginPath();var strokeStyle='rgba(0,0,0,0.2)';if(chart.config.options.horizontal_line.hasOwnProperty('strokeStyle')){strokeStyle=chart.config.options.horizontal_line.strokeStyle;}
...
ctx.save();ctx.beginPath();ctx.strokeStyle=strokeStyle;ctx.lineWidth=lineWidth;ctx.moveTo(xaxis.left,y);ctx.lineTo(xaxis.right,y);ctx.stroke();ctx.restore();if(data[line_id].label){ctx.save();ctx.lineWidth=0;var tmp=null;if(chart.config.options.horizontal_highlights.label.fillStyle.startsWith('#')){tmp=self.hexToRGB(chart.config.options.horizontal_highlights.label.fillStyle,chart.config.options.horizontal_highlights.label.opacity);}else if(chart.config.options.horizontal_highlights.label.fillStyle.startsWith('rgba(')){tmp=chart.config.options.horizontal_highlights.label.fillStyle;}else if(chart.config.options.horizontal_highlights.label.fillStyle.startsWith('rgb(')){tmp=self.hexToRGB(self.RGBToHex(chart.config.options.horizontal_highlights.label.fillStyle),chart.config.options.horizontal_highlights.label.opacity);}
if(tmp.hasOwnProperty('css')){ctx.fillStyle=tmp.css;}else if(tmp){ctx.fillStyle=tmp;}else{ctx.fillStyle=self.hexToRGB('#000',chart.config.options.horizontal_highlights.label.opacity);}
...
ctx.restore();}}}}
if(chart.config.options.hasOwnProperty('vertical_segments')&&chart.config.options.vertical_segments.enabled){var data=null;if(chart.config.options.vertical_segments.hasOwnProperty('data')){data=chart.config.options.vertical_segments.data;if(data){var ctx=this.chart.ctx;var xaxis=chart.scales['x-axis-0'];var topY=this.chart.scales['y-axis-0'].top;var bottomY=this.chart.scales['y-axis-0'].bottom;for(var segment_id=0;segment_id<data.length;segment_id++){var x_start=xaxis.getPixelForValue(data[segment_id].start_value);var x_stop=xaxis.getPixelForValue(data[segment_id].stop_value);if(data[segment_id].color){ctx.save();ctx.lineWidth=0;var tmp=null;if(data[segment_id].color.startsWith('#')){tmp=self.hexToRGB(data[segment_id].color,chart.config.options.vertical_segments.opacity).css;}else if(data[segment_id].color.startsWith('rgb(')){tmp=self.hexToRGB(self.RGBToHex(data[segment_id].color),chart.config.options.vertical_segments.opacity).css;}else if(data[segment_id].color.startsWith('rgba(')){tmp=data[segment_id].color;}
ctx.fillStyle=tmp;ctx.beginPath();ctx.fillRect(x_start,topY,(x_stop-x_start),(bottomY-topY));ctx.stroke();ctx.restore();}
if(data[segment_id].label){ctx.save();ctx.lineWidth=0;var tmp=null;if(chart.config.options.vertical_segments.label.fillStyle.startsWith('#')){tmp=self.hexToRGB(chart.config.options.vertical_segments.label.fillStyle,chart.config.options.vertical_segments.label.opacity);}else if(chart.config.options.vertical_segments.label.fillStyle.startsWith('rgba(')){tmp=chart.config.options.vertical_segments.label.fillStyle;}else if(chart.config.options.vertical_segments.label.fillStyle.startsWith('rgb(')){tmp=self.hexToRGB(self.RGBToHex(chart.config.options.vertical_segments.label.fillStyle),chart.config.options.vertical_segments.label.opacity);}
if(tmp.hasOwnProperty('css')){ctx.fillStyle=tmp.css;}else if(tmp){ctx.fillStyle=tmp;}else{ctx.fillStyle=self.hexToRGB('#000',chart.config.options.vertical_segments.label.opacity);}
...
ctx.save();ctx.lineWidth=lineWidth;ctx.strokeStyle=strokeStyle;for(var i=0;i<this.chart.tooltip._active.length;i++){var current_point=this.chart.tooltip._active[0];var x=current_point.tooltipPosition().x;ctx.beginPath();ctx.moveTo(x,topY);ctx.lineTo(x,bottomY);ctx.stroke();}
ctx.restore();}}
...
var strokeStyle='rgba(0,0,0,0.8)';ctx.save();ctx.lineWidth=lineWidth;var yaxis=chart.scales['y-axis-0'];for(var i=0;i<this.chart.tooltip._active.length;i++){var current_point=this.chart.tooltip._active[i];if(chart.config.options.horizontal_indicator_line.hasOwnProperty('strokeStyle')&&chart.config.options.horizontal_indicator_line.strokeStyle){strokeStyle=chart.config.options.horizontal_indicator_line.strokeStyle;}else{var color=null;if(current_point._model.borderColor.startsWith('rgb')){color=self.hexToRGB(self.RGBToHex(current_point._model.borderColor),0.15);}else{color=self.hexToRGB(current_point._model.borderColor,0.15);}
if(color){strokeStyle=color.css;}}
...
ctx.fillStyle=fillStyle;ctxx.beginPath();ctx.fillRect(left,y_min,right-left,(y_max-y_min));ctx.stroke();}
ctx.beginPath();ctx.moveTo(left,y);ctx.lineTo(right,y);ctx.stroke();}
ctx.restore();}}
if(!this.rendered&&ease!==1){return;}
this.rendered=true;var helpers=Chart.helpers;var meta=this.getMeta();var yScale=this.getScaleForId(meta.yAxisID);var data=this.getDataset().data;var data_min=this.getDataset().data_min;var data_max=this.getDataset().data_max;if(chart.config.options.hasOwnProperty('interval')&&chart.config.options.interval.enabled){if(data_min&&data_max){ctx.save();ctx.fillStyle=this.getDataset().backgroundColor;var lineWidth=0.4;if(chart.config.options.interval.hasOwnProperty('lineWidth')){lineWidth=chart.config.options.interval.lineWidth;}
...
if(chart.config.options.hasOwnProperty('error_bar')&&chart.config.options.error_bar.enabled){var xaxis=chart.scales['x-axis-0'];var yaxis=chart.scales['y-axis-0'];var dataset=this.getDataset();if(data_min&&data_max){var x_tipWidth_pixel=1.0;var y_tipWidth_pixel=1.0;$.each(chart.getDatasetMeta(0).data,function(index,item){var y=item._model.y;var x=item._model.x;ctx.save();var strokeStyle='rgba(0,0,0,0.2)';if(chart.config.options.error_bar.hasOwnProperty('strokeStyle')){strokeStyle=chart.config.options.error_bar.strokeStyle;}
...
ctx.beginPath();ctx.moveTo(x-tipWidth/2,y_max);ctx.lineTo(x+tipWidth/2,y_max);ctx.stroke();ctx.beginPath();ctx.moveTo(x-tipWidth/2,y_min);ctx.lineTo(x+tipWidth/2,y_min);ctx.stroke();ctx.beginPath();ctx.moveTo(x,y_max);ctx.lineTo(x,y_min);ctx.stroke();ctx.restore();});}}}});Chart.Tooltip.positioners.line_centered_top=function(elements,eventPosition){return{x:elements[0]._model.x,y:0};};Chart.Tooltip.positioners.line_centered_bottom=function(elements,eventPosition){return{x:elements[0]._model.x,y:elements[0]._chart.height};};Chart.Tooltip.positioners.inline_centered_bottom=function(elements,eventPosition){return{x:elements[0]._model.x,y:elements[0]._chart.height};};if(this.options.show_chart){this.options.element.chart_mode_selector+=this.uniqueId;this.options.element.table_mode_selector+=this.uniqueId;var toolbar_html='';toolbar_html+='<div id="datatable_toolbar'+this.uniqueId+'" class="datatable-toolbar" ';if(!this.options.show_toolbar){toolbar_html+=' style="display: none;" ';}
toolbar_html+='>';var active=' ';var pressed='false';if(this.options.table_default_mode==='show'){active=' active ';pressed='true';}
toolbar_html+='<button type="button" class="'+this.options.button_css.table+active+'" id="'+this.options.element.table_mode_selector+'" data-toggle="button" aria-pressed="'+pressed+'" autocomplete="off" ';if(!this.options.show_table_selector){toolbar_html+=' style="display: none;" ';}
toolbar_html+='>';toolbar_html+=this.options.icon.table+' '+this.options.label.table;toolbar_html+='</button>&nbsp;';toolbar_html+='<div class="btn-group" data-toggle="buttons" id="'+this.options.element.chart_mode_selector+'">';if(this.options.chart_modes.indexOf('bar')>-1){var active='';if(this.options.chart_default_mode=='bar'){active=' active ';}
...
if(this.options.chart_modes.indexOf('line')>-1){var active='';if(this.options.chart_default_mode=='line'){active=' active ';}
toolbar_html+='<label class="'+this.options.button_css.line+active+'" data-mode="line">';toolbar_html+='<input autocomplete="off" data-mode="line" name="options" type="radio" value="bar">'+this.options.icon.line+' '+this.options.label.line+'</input>';toolbar_html+='</label>';}
...
toolbar_html+='<label class="'+this.options.button_css.off+active+'" data-mode="off">';toolbar_html+='<input autocomplete="off" checked data-mode="off" name="options" type="radio" value="off">'+this.options.icon.off+' '+this.options.label.off+'</input>';toolbar_html+='</label>';toolbar_html+='</div>';toolbar_html+='</div>';var $div=$('<div>',{id:'datatable_visualization'+this.uniqueId,'class':'datatable'});if(this.options.chart_modes.indexOf('bar')>-1){var bar_div='<div id="bar_div'+this.uniqueId+'" style="display:none;"><canvas id="bar_chart'+this.uniqueId+'"></canvas></div>';this.options.element.bar.div='#bar_div'+this.uniqueId;this.options.element.bar.canvas='#bar_chart'+this.uniqueId;$($div).append(bar_div);}
if(this.options.chart_modes.indexOf('line')>-1){var line_div='<div id="line_div'+this.uniqueId+'" style="display:none;"><canvas id="line_chart'+this.uniqueId+'"></canvas></div>';this.options.element.line.div='#line_div'+this.uniqueId;this.options.element.line.canvas='#line_chart'+this.uniqueId;$($div).append(line_div);}
if(this.options.chart_modes.indexOf('scatter')>-1){var scatter_div='<div id="scatter_div'+this.uniqueId+'" style="display:none;">';scatter_div+='<canvas id="scatter_chart'+this.uniqueId+'"></canvas>';scatter_div+='<div class="btn-group">';scatter_div+='<div class="btn-group">';scatter_div+='<div class="dropdown">';scatter_div+='<button aria-expanded="false" aria-haspopup="true" class="btn btn-default dropdown-toggle" data-toggle="dropdown" id="scatter_selector_x'+this.uniqueId+'" type="button">X '+this.options.icon.caret+'</button>';scatter_div+='<ul aria-labelledby="scatter_selector_x'+this.uniqueId+'" class="dropdown-menu" id="scatter_selector_x_menu'+this.uniqueId+'" role="menu">';scatter_div+='<li class="dropdown-header">'+this.options.label.select_x_axis+'</li>';$(this.element).find('thead tr th[data-chartable="true"]').each(function(){var postfix='';if(typeof $(this).data('postfix')!=='undefined'){postfix=$(this).data('postfix');}
...
scatter_div+='<li'+active+'><a data-field="'+field+'" data-postfix="'+postfix+'" data-reversed="'+reversed+'" data-axis-label="'+axis_label+'" data-selected="'+selected+'" href="#" onclick="return false;">'+$.trim($(this).text())+'</a></li>'});scatter_div+='</ul>';scatter_div+='</div>';scatter_div+='</div>';scatter_div+='<div class="btn-group">';scatter_div+='<div class="dropdown">';scatter_div+='<button aria-expanded="false" aria-haspopup="true" class="btn btn-default dropdown-toggle" data-toggle="dropdown" id="scatter_selector_y'+this.uniqueId+'" type="button">Y '+this.options.icon.caret+'</button>';scatter_div+='<ul aria-labelledby="scatter_selector_y'+this.uniqueId+'" class="dropdown-menu" id="scatter_selector_y_menu'+this.uniqueId+'" role="menu">';scatter_div+='<li class="dropdown-header">'+this.options.label.select_y_axis+'</li>';$(this.element).find('thead tr th[data-chartable="true"]').each(function(){var postfix='';if(typeof $(this).data('postfix')!=='undefined'){postfix=$(this).data('postfix');}
var reversed=false;if(typeof $(this).data('reversed')!=='undefined'){reversed=$(this).data('reversed');}
if(typeof $(this).data('field')!=='undefined'){var field=$(this).data('field');}
var axis_label='';if(typeof $(this).data('axis-label')!=='undefined'){axis_label=$("<div/>").html($(this).data('axis-label')).text();}
var active='';var selected='0';if(field==self.options.scatter.y){active=' class="active" ';selected='1';}
scatter_div+='<li'+active+'><a data-field="'+field+'" data-postfix="'+postfix+'" data-reversed="'+reversed+'" data-axis-label="'+axis_label+'" data-selected="'+selected+'" href="#" onclick="return false;">'+$.trim($(this).text())+'</a></li>'});scatter_div+='</ul>';scatter_div+='</div>';scatter_div+='</div>';scatter_div+='</div>';scatter_div+='</div>';this.options.element.scatter.div='#scatter_div'+this.uniqueId;this.options.element.scatter.canvas='#scatter_chart'+this.uniqueId;this.options.element.scatter.selector_x_menu='#scatter_selector_x_menu'+this.uniqueId;this.options.element.scatter.selector_y_menu='#scatter_selector_y_menu'+this.uniqueId;$($div).append(scatter_div);$(document).on("click",this.options.element.scatter.selector_x_menu+' li a',function(){$(self.options.element.scatter.selector_x_menu+' li a').each(function(){$(this).data('selected',0);$(this).parent().removeClass('active');});$(this).data('selected',1);$(this).parent().addClass('active');self.updateScatter();});$(document).on("click",this.options.element.scatter.selector_y_menu+' li a',function(){$(self.options.element.scatter.selector_y_menu+' li a').each(function(){$(this).data('selected',0);$(this).parent().removeClass('active');});$(this).data('selected',1);$(this).parent().addClass('active');self.updateScatter();});}
...
$(element).find('[data-toggle="tooltip"]').tooltip({html:true});$(element).find('.datatable-inline-bar-vertical').each(function(){var data=self.parseDataList($(this).data('value'));$(this).attr("width",data.length*(self.options.inline_chart.bar_vertical.item_width+3));$(this).attr("height",self.options.inline_chart.height);var values=[];var labels=[];var bg_colors=[];var min_y_value=Infinity;var max_y_value=-Infinity;for(var i=0;i<data.length;i++){values.push(parseFloat(data[i]['y_value']));labels.push(i);if(data[i]['color']){bg_colors.push(data[i]['color']);}else{bg_colors.push(self.options.inline_chart.bar_vertical.colors.default);}
if(data[i]['y_value']>max_y_value){max_y_value=data[i]['y_value'];}
if(data[i]['y_value']<min_y_value){min_y_value=data[i]['y_value'];}}
var hline=$.extend(true,{},self.options.inline_chart.bar_vertical.hline,{enabled:false,values:[]});var options=self.options.inline_chart.bar_vertical.options;if(self.options.inline_chart.bar_vertical.options.scales.y_axes_maximize){if(max_y_value>0&&min_y_value<0){hline.enabled=true;hline.values.push(0);options.scales.yAxes[0].ticks.min=min_y_value;options.scales.yAxes[0].ticks.max=max_y_value;}
...
var inlineChart=new Chart(this,{type:'lineWithLine',data:{labels:labels,datasets:[$.extend(true,{},self.options.inline_chart.line_steps.data,{data:char_data})],hline:hline},options:options});}
...
self.chart_update=true;});$('#'+this.options.element.table_mode_selector).on('click',function(){if($(this).hasClass('active')){self.table_mode='hide';}else{self.table_mode='show';}
self.updateTableVisibility(self.table_mode);});$('#'+this.options.element.chart_mode_selector+' label').on('click',function(){self.chart_mode=$(this).data('mode');self.updateVisualizationVisibility(self.chart_mode);});this.updateFieldMeta();if(typeof $(element).data('json')!=='undefined'){var json_datafile=$(element).data('json');jQuery.ajax({type:'GET',mimeType:"application/json; charset=utf-8",url:json_datafile,dataType:'json',async:true,success:function(data){var $thead=$(self.element).find('thead');var $tbody=$('<tbody></tbody>');$.each(data,function(key,val){var $row=$('<tr></tr>');if(val.hline){$row.attr('data-hline',true);}
...
$.each(self.field_meta,function(header_key,header_val){$($row).append($('<td></td>').text(val[header_val.field]));});$($tbody).append($row);});$($tbody).insertAfter($thead);self.updateTags();$(self.element).trigger('post-init.datatable');},error:function(){console.log('ERROR reading file:'+json_datafile);}});}else if(typeof $(element).data('yaml')!=='undefined'){var yaml_datafile=$(element).data('yaml');jQuery.ajax({type:'GET',dataType:'text',mimeType:"application/yaml; charset=utf-8",url:yaml_datafile,async:true,success:function(text){try{var data=jsyaml.safeLoad(text);var $thead=$(self.element).find('thead');var $tbody=$('<tbody></tbody>');$.each(data.data,function(key,val){var $row=$('<tr></tr>');if(val.hline){$row.attr('data-hline',true);}
if(self.options.table.row_highlighting){if(val.row_css=='active'){$row.addClass('active');}else if(val.row_css=='success'){$row.addClass('success');}else if(val.row_css=='info'){$row.addClass('info');}else if(val.row_css=='warning'){$row.addClass('warning');}else if(val.row_css=='danger'){$row.addClass('danger');}}
$.each(self.field_meta,function(header_key,header_val){$($row).append($('<td></td>').text(val[header_val.field]));});$($tbody).append($row);});$($tbody).insertAfter($thead);self.updateTags();$(self.element).trigger('post-init.datatable');}catch(e){console.log(e);}},error:function(){console.log('ERROR reading file:'+yaml_datafile);}});}else{self.updateTags();$(self.element).trigger('post-init.datatable');}},updateFieldMeta:function(){var self=this;this.field_meta=[];$(this.element).find('thead tr th').each(function(){var meta={field:null,rank:null,chartable:null,sortable:null,visible:null,beginatzero:null,align:null,tag:null,filter_control:null,formatter:null,postfix:null};if(typeof $(this).data('field')!=='undefined'){meta.field=$(this).data('field');}
...
if(meta.field!=null|| meta.rank){self.field_meta.push(meta);}});},updateTableVisibility:function(mode){if(mode=='show'){$(this.$element[0].closest('.fixed-table-container')).show(this.options.animation.show_speed);}else if(mode=='hide'){$(this.$element[0].closest('.fixed-table-container')).hide(this.options.animation.show_speed);}},updateVisualizationVisibility:function(mode){if(mode=='off'){if(this.options.chart_modes.indexOf('bar')>-1){this.hideBarChart();}
if(this.options.chart_modes.indexOf('line')>-1){this.hideLineChart();}
if(this.options.chart_modes.indexOf('scatter')>-1){this.hideScatterChart();}
if(this.options.chart_modes.indexOf('comparison')>-1){this.hideComparisonChart();}}else if(mode=='bar'){if(this.options.chart_modes.indexOf('line')>-1){this.hideLineChart();}
if(this.options.chart_modes.indexOf('scatter')>-1){this.hideScatterChart();}
if(this.options.chart_modes.indexOf('comparison')>-1){this.hideComparisonChart();}
this.showBarChart();}else if(mode=='line'){if(this.options.chart_modes.indexOf('bar')>-1){this.hideBarChart();}
if(this.options.chart_modes.indexOf('scatter')>-1){this.hideScatterChart();}
if(this.options.chart_modes.indexOf('comparison')>-1){this.hideComparisonChart();}
this.showLineChart();}else if(mode=='scatter'){if(this.options.chart_modes.indexOf('bar')>-1){this.hideBarChart();}
if(this.options.chart_modes.indexOf('line')>-1){this.hideLineChart();}
if(this.options.chart_modes.indexOf('comparison')>-1){this.hideComparisonChart();}
this.showScatterChart();}else if(mode=='comparison'){if(this.options.chart_modes.indexOf('bar')>-1){this.hideBarChart();}
if(this.options.chart_modes.indexOf('line')>-1){this.hideLineChart();}
if(this.options.chart_modes.indexOf('scatter')>-1){this.hideScatterChart();}
this.showComparisonChart();}},initBootstrapTable:function(){$(this.element).bootstrapTable();$(this.element).trigger('post-body.bs.table');},updateChart:function(){if(this.options.show_chart){if(this.chart_mode=='off'){}else if(this.chart_mode=='bar'){this.updateBar();}else if(this.chart_mode=='line'){this.updateLine();}else if(this.chart_mode=='scatter'){this.updateScatter();}else if(this.chart_mode=='comparison'){this.updateComparison();}}},validBar:function(){var table_options=$(this.element).bootstrapTable('getOptions');var sort_name=table_options.sortName;var header=$(this.element).find('thead tr th[data-field=\"'+sort_name+'\"]');var chartable=false;if(typeof header.data('chartable')!=='undefined'){chartable=header.data('chartable');}
var table_data=$(this.element).bootstrapTable('getData');if(table_data.length>0&&chartable){return true;}else{return false;}},updateBar:function(){var self=this;if(this.bar_chart){this.bar_chart.destroy();}
...
var value_label=header.text().trim();if(typeof header.data('axis-label')!=='undefined'){value_label=$("<div/>").html(header.data('axis-label')).text().trim();}
var value_formatter=null;if(typeof header.data('formatter')!=='undefined'){value_formatter=header.data('formatter');}
var labels=[];var data=[];var data_uniqueid=[];var data_min=[];var data_max=[];var data_string=[];var all_value_min=Infinity;var all_value_max=-Infinity;var border_colors=[];var border_hover_colors=[];var bg_colors=[];var bg_hover_colors=[];var horizontal_line_value=[];var horizontal_line_color=[];for(var i=0;i<table_data.length;i++){var label=$("<div/>").html(table_data[i][this.options.table.id_field]).text().trim().replace(/<(?:.|\n)*?>/gm,'').replace('_',' ');if(labels.indexOf(label)>-1){var num_of_occurances=0;for(var i=0;i<labels.length;i++){if(labels[i]===label)
num_of_occurances++;}
label=label+new Array(num_of_occurances+1).join(' ');}
labels.push(label);var item=self.parseNumericValue(table_data[i][sort_name]);data.push(item.value);if(value_formatter){data_string.push(this.stripHTML(window[value_formatter](table_data[i][sort_name])));}else{data_string.push(this.injectValuePostfix(table_data[i][sort_name],value_postfix));}
data_uniqueid.push(table_data[i][table_options.idField]);var value_max=item.value_max;var value_min=item.value_min;if(all_value_max<item.value){all_value_max=item.value;}
...
data_min.push(value_min);data_max.push(value_max);if(table_data[i].hasOwnProperty('_data')&&table_data[i]['_data'].hasOwnProperty('hline')&&typeof table_data[i]['_data']['hline']!=='undefined'&&table_data[i]['_data']['hline']){horizontal_line_value.push(item.value);if(table_data[i].hasOwnProperty('_class')&&typeof table_data[i]['_class']!=='undefined'){horizontal_line_color.push(this.options.bar.colors[table_data[i]['_class']].bg.normal);}else{horizontal_line_color.push(this.options.bar.colors.default.bg.normal);}}
if(table_data[i].hasOwnProperty('_class')&&typeof table_data[i]['_class']!=='undefined'){if(this.options.bar.colors.valid.indexOf(table_data[i]['_class'])>-1){border_colors.push(this.options.bar.colors[table_data[i]['_class']].border.normal);border_hover_colors.push(this.options.bar.colors[table_data[i]['_class']].border.hover);bg_colors.push(this.options.bar.colors[table_data[i]['_class']].bg.normal);bg_hover_colors.push(this.options.bar.colors[table_data[i]['_class']].bg.hover);}else{border_colors.push(this.options.bar.colors.default.border.normal);border_hover_colors.push(this.options.bar.colors.default.border.hover);bg_colors.push(this.options.bar.colors.default.bg.normal);bg_hover_colors.push(this.options.bar.colors.default.bg.hover);}}else{border_colors.push(this.options.bar.colors.default.border.normal);border_hover_colors.push(this.options.bar.colors.default.border.hover);bg_colors.push(this.options.bar.colors.default.bg.normal);bg_hover_colors.push(this.options.bar.colors.default.bg.hover);}
if(item.value>value_max){value_max=item.value;}
if(item.value<value_max){value_min=item.value;}}
if(chartable&&data.length>0){$(this.options.element.bar.div).show(0);var begin_at_zero=$(this.element).find('thead tr th[data-field=\"'+sort_name+'\"]').data('beginatzero');var axis_scale='linear';var axis_scale_type=null;if(typeof header.data('axis-scale')!=='undefined'){if(header.data('axis-scale').startsWith('log')){axis_scale='logarithmic';axis_scale_type='log';if(header.data('axis-scale')==='log_unit'){axis_scale_type='log_unit';}else if(header.data('axis-scale')==='log_exp'){axis_scale_type='log_exp';}else if(header.data('axis-scale')==='log10'){axis_scale_type='log10';}else if(header.data('axis-scale')==='log10_unit'){axis_scale_type='log10_unit';}else if(header.data('axis-scale')==='log10_exp'){axis_scale_type='log10_exp';}}}
var chart_data={labels:labels,datasets:[{label:sort_name,data:data,data_min:data_min,data_max:data_max,data_string:data_string,data_uniqueid:data_uniqueid,horizontal_line_value:horizontal_line_value,horizontal_line_color:horizontal_line_color,backgroundColor:bg_colors,borderColor:border_colors,borderWidth:2,hoverBackgroundColor:bg_hover_colors,hoverBorderColor:border_hover_colors}]};var tooltip_position='average';var padding={left:0,right:0,top:0,bottom:0};var caretSize=5;var caretPadding=2;if(this.options.bar.tooltips.position==='top'){tooltip_position='line_centered_top';padding={left:0,right:0,top:45,bottom:0};caretSize=0;caretPadding=0;}else if(this.options.bar.tooltips.position==='bottom'){tooltip_position='line_centered_bottom';padding={left:0,right:0,top:0,bottom:45};caretSize=0;caretPadding=0;}
var chart_options={layout:{padding:padding},scales:{xAxes:[{display:this.options.bar.show_xaxis,stacked:false,ticks:{autoSkip:false,maxRotation:90}}],yAxes:[{stacked:false,type:axis_scale,ticks:{beginAtZero:begin_at_zero,suggestedMax:all_value_max,suggestedMin:all_value_min},scaleLabel:{display:true,labelString:value_label,fontColor:'black'}}]},maintainAspectRatio:true,responsive:true,animation:{duration:this.options.animation.duration},title:{display:false},legend:{display:false},vertical_indicator_line:{enabled:this.options.bar.vertical_indicator_line.enabled,lineWidth:this.options.bar.vertical_indicator_line.lineWidth,strokeStyle:this.options.bar.vertical_indicator_line.strokeStyle},horizontal_highlights:{enabled:this.options.bar.horizontal_highlights.enabled,data:this.options.bar.horizontal_highlights.data,opacity:this.options.bar.horizontal_highlights.opacity,lineWidth:this.options.bar.horizontal_highlights.lineWidth,strokeStyle:this.options.bar.horizontal_highlights.strokeStyle,label:{fillStyle:this.options.bar.horizontal_highlights.label.fillStyle,font:this.options.bar.horizontal_highlights.label.font,fontSize:this.options.bar.horizontal_highlights.label.fontSize,position:this.options.bar.horizontal_highlights.label.position,opacity:this.options.bar.horizontal_highlights.label.opacity}},horizontal_line:{enabled:this.options.bar.horizontal_line.enabled},horizontal_indicator_line:{enabled:this.options.bar.horizontal_indicator_line.enabled,lineWidth:this.options.bar.horizontal_indicator_line.lineWidth,strokeStyle:this.options.bar.horizontal_indicator_line.strokeStyle,fillStyle:this.options.bar.horizontal_indicator_line.fillStyle},error_bar:{enabled:this.options.bar.error_bar.enabled,lineWidth:this.options.bar.error_bar.lineWidth,tipWidth:this.options.bar.error_bar.tipWidth,strokeStyle:this.options.bar.error_bar.strokeStyle},tooltips:{enabled:true,mode:'label',position:tooltip_position,caretSize:caretSize,caretPadding:caretPadding,titleFontSize:this.options.bar.tooltips.titleFontSize,bodyFontSize:this.options.bar.tooltips.bodyFontSize,callbacks:{title:function(tooltipItem,data){return data.labels[tooltipItem[0].index];},label:function(tooltipItems,data){var data_string=data.datasets[tooltipItems.datasetIndex].data_string[tooltipItems.index];return value_label+': '+data_string;}}},chartArea:{backgroundColor:this.options.bar.colors.background},onHover:function(event,elements){if(event.type=='mouseout'||event.type=='touchend'){$(self.element).find('tr td').removeClass('row-hover');}else if(event.type=='mousemove'){if(elements.length>0){$(self.element).find('tr td').removeClass('row-hover');var value_index=elements[0]._index;var table_options=$(self.element).bootstrapTable('getOptions');var row_index=value_index;if(table_options.pagination){var page_number=Math.floor(value_index/table_options.pageSize)+1;if(page_number==table_options.pageNumber){row_index=value_index%table_options.pageSize;$(self.element).find('tbody tr:nth-child('+(row_index+1)+') td').addClass('row-hover');}}else{$(self.element).find('tbody tr:nth-child('+(row_index+1)+') td').addClass('row-hover');}}}}};if(axis_scale==='logarithmic'){chart_options.scales.yAxes[0].ticks.callback=function(value,index,values){if(axis_scale_type.startsWith('log10')){if(!(value===1e1||value===1e2||value===1e3||value===1e4||value===1e5||value===1e6||value===1e7||value===1e8||value===1e9||value===1e10)){return'';}}else if(axis_scale_type.startsWith('log')){if(values.length>10){if(index%Math.ceil(values.length/10.0)!==0){return'';}}}
...
this.bar_chart=new Chart(chart_ctx,{type:'barError',data:chart_data,options:chart_options});}else{if($(this.options.element.bar.div).is(":visible")){$(this.options.element.bar.div).hide(0);}}},updateLine:function(){var self=this;if(this.line_chart){this.line_chart.destroy();}
var chart_ctx=document.getElementById(this.options.element.line.canvas.replace('#',''));chart_ctx.width=$(this.options.element.line.div).innerWidth();chart_ctx.height=this.options.line.height;var table_options=$(this.element).bootstrapTable('getOptions');var table_data=$(this.element).bootstrapTable('getData');var xaxis_field=table_options.idField;if(this.options.line.xaxis.field){xaxis_field=this.options.line.xaxis.field}
if(this.options.line.xaxis.sorted){table_data.sort(function(a,b){a=self.convertValue(a[xaxis_field],-Infinity);b=self.convertValue(b[xaxis_field],-Infinity);if(a<b){return-1;}
if(a>b){return 1;}
return 0;});}
var labels=[];for(var i=0;i<table_data.length;i++){var label=$("<div/>").html(table_data[i][xaxis_field]).text().trim().replace(/<(?:.|\n)*?>/gm,'').replace('_',' ');if(labels.indexOf(label)>-1){var num_of_occurances=0;for(var label_id=0;label_id<labels.length;label_id++){if(labels[label_id]===label)
num_of_occurances++;}
label=label+new Array(num_of_occurances+1).join(' ');}
labels.push(label);}
var axis_scale='linear';var axis_scale_type=null;var time_mode=false;if((new Date(labels[0])).getTime()>0){time_mode=true;}
var datasets=[];var dataset_id=0;var all_value_max=-Infinity;var all_value_min=Infinity;var beginAtZero=this.options.line.yaxis.beginatzero;$(this.element).find("thead tr th[data-field!=''][data-field]").each(function(index,header){if(typeof $(this).data('chartable')!=='undefined'&&$(this).data('chartable')){if(!beginAtZero){beginAtZero=$(this).data('beginatzero');}
var dataset_name=self.cleanFieldValue($(this).html());var field_name=$(this).data('field');var valid_dataset=false;if(self.options.line.fields){if(self.options.line.fields.includes(field_name)){valid_dataset=true;}}else{valid_dataset=true;}
if(valid_dataset){var value_formatter=null;if(typeof $(this).data('formatter')!=='undefined'){value_formatter=$(this).data('formatter');}
if(typeof $(this).data('axis-scale')!=='undefined'){if($(this).data('axis-scale').startsWith('log')){axis_scale='logarithmic';axis_scale_type='log';if($(this).data('axis-scale')==='log_unit'){axis_scale_type='log_unit';}else if($(this).data('axis-scale')==='log_exp'){axis_scale_type='log_exp';}else if($(this).data('axis-scale')==='log10'){axis_scale_type='log10';}else if($(this).data('axis-scale')==='log10_unit'){axis_scale_type='log10_unit';}else if($(this).data('axis-scale')==='log10_exp'){axis_scale_type='log10_exp';}}}
var data=[];var data_uniqueid=[];var data_min=[];var data_max=[];var data_string=[];var horizontal_line_value=[];var point_border_colors=[];var point_border_hover_colors=[];var point_bg_colors=[];var point_bg_hover_colors=[];var point_radius=[];var point_hover_radius=[];for(var i=0;i<table_data.length;i++){if(value_formatter){data_string.push(self.stripHTML(window[value_formatter](table_data[i][field_name])));}else{data_string.push(self.injectValuePostfix(table_data[i][field_name],value_postfix));}
data_uniqueid.push(table_data[i][table_options.idField]);var item=self.parseNumericValue(table_data[i][field_name]);if(time_mode){var time_label=$("<div/>").html(table_data[i][xaxis_field]).text().trim().replace(/<(?:.|\n)*?>/gm,'').replace('_',' ');data.push({x:time_label,y:item.value});}else{data.push(item.value);}
...
if(all_value_max<value_max){all_value_max=value_max;}
if(all_value_min>value_min){all_value_min=value_min;}}
data_min.push(value_min);data_max.push(value_max);if(table_data[i].hasOwnProperty('_data')&&table_data[i]['_data'].hasOwnProperty('hline')&&typeof table_data[i]['_data']['hline']!=='undefined'&&table_data[i]['_data']['hline']){horizontal_line_value.push(item.value);}
if(table_data[i].hasOwnProperty('_class')&&typeof table_data[i]['_class']!=='undefined'){if(self.options.line.colors.valid.indexOf(table_data[i]['_class'])>-1){point_border_colors.push(self.options.line.colors[table_data[i]['_class']].border.normal);point_border_hover_colors.push(self.options.line.colors[table_data[i]['_class']].border.hover);point_bg_colors.push(self.options.line.colors[table_data[i]['_class']].bg.normal);point_bg_hover_colors.push(self.options.line.colors[table_data[i]['_class']].border.hover);}else{point_border_colors.push(self.hexToRGB(self.options.line.colors.datasets[dataset_id],0.5).css);point_border_hover_colors.push(self.hexToRGB(self.options.line.colors.datasets[dataset_id],0.8).css);point_bg_colors.push(self.hexToRGB(self.options.line.colors.datasets[dataset_id],0.5).css);point_bg_hover_colors.push(self.hexToRGB(self.options.line.colors.datasets[dataset_id],0.8).css);}}else{point_border_colors.push(self.hexToRGB(self.options.line.colors.datasets[dataset_id],0.5).css);point_border_hover_colors.push(self.hexToRGB(self.options.line.colors.datasets[dataset_id],0.8).css);point_bg_colors.push(self.hexToRGB(self.options.line.colors.datasets[dataset_id],0.5).css);point_bg_hover_colors.push(self.hexToRGB(self.options.line.colors.datasets[dataset_id],0.8).css);}
if(self.options.line.point.enabled){point_radius.push(self.options.line.point.radius.normal);point_hover_radius.push(self.options.line.point.radius.hover);}else{point_radius.push(0);point_hover_radius.push(0);}}
var value_postfix='';if(typeof $(this).data('postfix')!=='undefined'){value_postfix=$(this).data('postfix');}
datasets.push({label:dataset_name,data:data,data_uniqueid:data_uniqueid,data_min:data_min,data_max:data_max,data_string:data_string,horizontal_line_value:horizontal_line_value,value_postfix:value_postfix,borderWidth:2,borderColor:self.hexToRGB(self.options.line.colors.datasets[dataset_id]).css,lineTension:0,spanGaps:true,fill:self.options.line.fill,backgroundColor:self.hexToRGB(self.options.line.colors.datasets[dataset_id],0.10).css,pointRadius:point_radius,pointHoverRadius:point_hover_radius,pointBackgroundColor:point_bg_colors,pointBorderWidth:point_border_colors,pointHoverBackgroundColor:point_bg_hover_colors,pointHoverBorderColor:point_border_hover_colors});dataset_id++;}}});if(!axis_scale_type){if(this.options.line.yaxis.scale){if(this.options.line.yaxis.scale.startsWith('log')){axis_scale='logarithmic';axis_scale_type='log';if(this.options.line.yaxis.scale==='log_unit'){axis_scale_type='log_unit';}else if(this.options.line.yaxis.scale==='log_exp'){axis_scale_type='log_exp';}else if(this.options.line.yaxis.scale==='log10'){axis_scale_type='log10';}else if(this.options.line.yaxis.scale==='log10_unit'){axis_scale_type='log10_unit';}else if(this.options.line.yaxis.scale==='log10_exp'){axis_scale_type='log10_exp';}}}}
$(this.options.element.line.div).show(0);var chart_data={labels:labels,datasets:datasets};var show_legend=false;if(datasets.length>1){if(this.options.line.legend.enabled){show_legend=true;}}
var tooltip_position='average';var padding={left:0,right:0,top:0,bottom:0};if(this.options.line.tooltips.position=='top'){tooltip_position='line_centered_top';padding={left:0,right:0,top:40+datasets.length*12,bottom:0};}else if(this.options.line.tooltips.position=='bottom'){tooltip_position='line_centered_bottom';padding={left:0,right:0,top:0,bottom:40+datasets.length*12};}
var chart_options={showLines:this.options.line.line.enabled,elements:{line:{tension:this.options.line.line.tension}},layout:{padding:padding},scales:{xAxes:[{display:this.options.line.xaxis.display,stacked:false,ticks:{maxRotation:90},gridLines:{display:this.options.line.xaxis.gridlines}}],yAxes:[{stacked:false,type:axis_scale,ticks:{beginAtZero:beginAtZero,suggestedMin:all_value_min,suggestedMax:all_value_max},gridLines:{display:this.options.line.yaxis.gridlines}}],},maintainAspectRatio:true,responsive:true,animation:{duration:0},hover:{animationDuration:0},responsiveAnimationDuration:0,title:{display:false},legend:{display:show_legend,position:this.options.line.legend.position},horizontal_highlights:{enabled:this.options.line.horizontal_highlights.enabled,data:this.options.line.horizontal_highlights.data,opacity:this.options.line.horizontal_highlights.opacity,lineWidth:this.options.line.horizontal_highlights.lineWidth,strokeStyle:this.options.line.horizontal_highlights.strokeStyle,label:{fillStyle:this.options.line.horizontal_highlights.label.fillStyle,font:this.options.line.horizontal_highlights.label.font,fontSize:this.options.line.horizontal_highlights.label.fontSize,position:this.options.line.horizontal_highlights.label.position,opacity:this.options.line.horizontal_highlights.label.opacity}},horizontal_line:{enabled:this.options.line.horizontal_line.enabled,lineWidth:this.options.line.horizontal_line.lineWidth,strokeStyle:this.options.line.horizontal_line.strokeStyle},vertical_indicator_line:{enabled:this.options.line.vertical_indicator_line.enabled,lineWidth:this.options.line.vertical_indicator_line.lineWidth,strokeStyle:this.options.line.vertical_indicator_line.strokeStyle},vertical_segments:{enabled:this.options.line.vertical_segments.enabled,data:this.options.line.vertical_segments.data,opacity:this.options.line.vertical_segments.opacity,label:{fillStyle:this.options.line.vertical_segments.label.fillStyle,font:this.options.line.vertical_segments.label.font,fontSize:this.options.line.vertical_segments.label.fontSize,position:this.options.line.vertical_segments.label.position,opacity:this.options.line.vertical_segments.label.opacity}},horizontal_indicator_line:{enabled:this.options.line.horizontal_indicator_line.enabled,lineWidth:this.options.line.horizontal_indicator_line.lineWidth,fillStyle:this.options.line.horizontal_indicator_line.fillStyle,strokeStyle:this.options.line.horizontal_indicator_line.strokeStyle},interval:{enabled:this.options.line.interval.enabled,lineWidth:this.options.line.interval.lineWidth},error_bar:{enabled:this.options.line.error_bar.enabled,lineWidth:this.options.line.error_bar.lineWidth,strokeStyle:this.options.line.error_bar.strokeStyle,tipWidth:this.options.line.error_bar.tipWidth},tooltips:{enabled:true,mode:'label',position:tooltip_position,intersect:false,caretSize:0,caretPadding:0,callbacks:{afterBody:function(tooltipItems,data){$(self.element).find('tr td').removeClass('row-hover');var table_options=$(self.element).bootstrapTable('getOptions');for(var i=0;i<tooltipItems.length;i++){var value_index=tooltipItems[i].index;$(self.element).find('tbody td:contains('+table_options.data[value_index][table_options.idField]+')').parent('tr').find('td').addClass('row-hover')}},label:function(tooltipItems,data){var data_string=data.datasets[tooltipItems.datasetIndex].data_string[tooltipItems.index];return data_string+' ('+data.datasets[tooltipItems.datasetIndex].label+')';}}},chartArea:{backgroundColor:this.options.line.colors.background},onHover:function(event,elements){if(event.type=='mouseout'||event.type=='touchend'){$(self.element).find('tr td').removeClass('row-hover');}else if(event.type=='mousemove'){if(elements.length>0){$(self.element).find('tr td').removeClass('row-hover');var value_index=elements[0]._index;var table_options=$(self.element).bootstrapTable('getOptions');$(self.element).find('tbody td:contains('+table_options.data[value_index][table_options.idField]+')').parent('tr').find('td').addClass('row-hover')}}}};if(time_mode){chart_options.scales.xAxes[0].type='time';chart_options.scales.xAxes[0].distribution='linear';chart_options.scales.xAxes[0].time={};chart_options.scales.xAxes[0].time.displayFormats=this.options.time.display_formats;if(this.options.line.xaxis.timeunit){chart_options.scales.xAxes[0].time.unit=this.options.line.xaxis.timeunit;}
if(this.options.line.xaxis.timestepsize){chart_options.scales.xAxes[0].time.stepSize=this.options.line.xaxis.timestepsize;}
chart_options.scales.xAxes[0].ticks={};}
if(this.options.line.yaxis.label){chart_options.scales.yAxes[0].scaleLabel={display:true,labelString:this.options.line.yaxis.label,fontColor:'black'}}
if(axis_scale==='logarithmic'){chart_options.scales.yAxes[0].ticks.callback=function(value,index,values){if(axis_scale_type.startsWith('log10')){if(!(value===1e1||value===1e2||value===1e3||value===1e4||value===1e5||value===1e6||value===1e7||value===1e8||value===1e9||value===1e10)){return'';}}else if(axis_scale_type.startsWith('log')){if(values.length>10){if(index%Math.ceil(values.length/10.0)!==0){return'';}}}
if(axis_scale_type.endsWith('_unit')){return self.addNumberPrefix(value);}else if(axis_scale_type.endsWith('_exp')){return value.toExponential(2);}else{return value;}}}
this.line_chart=new Chart(chart_ctx,{type:'stripe',data:chart_data,options:chart_options});this.line_chart_data=chart_data;},updateScatter:function(){var self=this;if(this.scatter_chart){this.scatter_chart.destroy();}
...
html+='<span class="'+tag_css+'">'+item.trim()+'</span>';});$(this).find('td').eq(index).html(html);})}})}else if(this.options.tag_mode=='column'){var map={};$.each(this.field_meta,function(index,meta){if(meta.tag){var values={};$(self.element).find('tbody tr').each(function(){var value=$(this).find('td').eq(index).text().trim();value.split(',').forEach(function(item){if(!(item.trim()in values)){values[item.trim()]=0;}
values[item.trim()]++;});});var sortable=[];for(var value_group in values){sortable.push([value_group,values[value_group]]);sortable.sort(function(a,b){return b[1]-a[1]})}
$.each(sortable,function(i,val){map[val[0]]=i;});$(self.element).find('tbody tr').each(function(){var value=$(this).find('td').eq(index).text().trim();var html='';value.split(',').forEach(function(item){var tag_css=self.options.tags.css[map[item.trim()]];if(tag_css==undefined){var tag_css=self.options.tags.css[self.options.tags.css.length-1];}
...
$(this.element).bootstrapTable('updateCell',{index:0,field:'rank',value:'-'});},getRank:function(index){return this.table_rank[index];},log:function(string){if(this.options.debug){console.log(string);}},stripHTML:function(element){return $("<div/>").html(element).text();},svgElement:function(type,size,fill_color,tooltip,use_vertical_offset,vertical_offset){var html='<svg ';var hover_increase=2;if(use_vertical_offset){html+='height="'+(size*2+hover_increase*2)+'" ';}else{html+='height="'+(size+hover_increase*2)+'" ';}
...
data.push(data_item);}}}
return data;},cleanFieldValue:function(value){return $("<div/>").html(value).text().trim().replace(/<(?:.|\n)*?>/gm,'').replace('_',' ');},valueSorter:function(a,b,direction){direction=typeof direction!=='undefined'?direction:'asc';a=this.convertValue(a,-Infinity);b=this.convertValue(b,-Infinity);if(direction=='asc'){if(a<b){return-1;}
if(a>b){return 1;}
return 0;}else{if(a<b){return 1;}
if(a>b){return-1;}
return 0;}},convertValue:function(value,default_value){if(moment(value,this.options.time.valid_formats,true).isValid()&&!$.isNumeric(value)){value=moment(value).unix();}else{if(value){if(value.trim()){var float_value=parseFloat(value.replace('%',''));if(!isNaN(float_value)){value=float_value;}}else{value=default_value;}}else{value=default_value;}}
return value;},parseNumericValue:function(value){var pattern_interval=new RegExp(/([+-]?([0-9]*[.])?[0-9]+)(\s+)[(]([+-]?([0-9]*[.])?[0-9]+)(\s+)[-](\s+)([+-]?([0-9]*[.])?[0-9]+)[)]/);var pattern_plusminus=new RegExp(/([+-]?([0-9]*[.])?[0-9]+)(\s+)?[±](\s+)?(([0-9]*[.])?[0-9]+)/);var matches;if((matches=pattern_interval.exec(value))!==null){return{value:this.convertValue(matches[1]),value_min:this.convertValue(matches[4]),value_max:this.convertValue(matches[8])}}else if((matches=pattern_plusminus.exec(value))!==null){return{value:this.convertValue(matches[1]),value_min:this.convertValue(matches[1])-this.convertValue(matches[5]),value_max:this.convertValue(matches[1])+this.convertValue(matches[5]),}}else{return{value:this.convertValue(value),value_min:null,value_max:null}}},injectValuePostfix:function(value,postfix){var pattern_interval=new RegExp(/([+-]?([0-9]*[.])?[0-9]+)(\s+)[(]([+-]?([0-9]*[.])?[0-9]+)(\s+)[-](\s+)([+-]?([0-9]*[.])?[0-9]+)[)]/);var pattern_plusminus=new RegExp(/([+-]?([0-9]*[.])?[0-9]+)(\s+)?[±](\s+)?(([0-9]*[.])?[0-9]+)/);var matches;if((matches=pattern_interval.exec(value))!==null){return matches[1]+' '+postfix+' ('+matches[4]+' - '+matches[8]+')';}else if((matches=pattern_plusminus.exec(value))!==null){return matches[1]+' '+postfix+' ±'+matches[5];}else{return value+' '+postfix;}},resetChartTooltip:function(chart_object,dataset_index){chart_object.tooltip._active=[];chart_object.tooltip.update(true);chart_object.draw();chart_object.updateHoverStyle(chart_object.getDatasetMeta(dataset_index).data,null,false);chart_object.render();},openChartTooltip:function(chart_object,dataset_index,point_index){if(typeof chart_object.tooltip._active==='undefined'){chart_object.tooltip._active=[];}
var activeElements=chart_object.tooltip._active;var requestedElem=chart_object.getDatasetMeta(dataset_index).data[point_index];for(var i=0;i<activeElements.length;i++){if(requestedElem._index==activeElements[i]._index)
return;}
activeElements.push(requestedElem);chart_object.tooltip._active=activeElements;chart_object.tooltip.update(true);chart_object.draw();chart_object.updateHoverStyle([requestedElem],null,true);chart_object.render();},closeChartTooltip:function(chart_object,dataset_index,point_index){var activeElements=chart_object.tooltip._active;if(typeof activeElements==='undefined'||activeElements.length==0){return;}
...
chart_object.tooltip._active=activeElements;chart_object.tooltip.update(true);chart_object.draw();},hexToRGB:function(hex,opacity){hex=(hex+'').trim();var rgb=null;var match=hex.match(/^#?(([0-9a-zA-Z]{3}){1,3})$/);if(!match){return null;}
...
("0"+parseInt(rgb[3],10).toString(16)).slice(-2):'';},addNumberPrefix:function(value,min){min=min||1e3;if(value>=min){var units=["k","M","B","T"];var order=Math.floor(Math.log(value)/Math.log(1000));return Math.floor(value/Math.pow(1000,order))+units[(order-1)];}
return value.toLocaleString();}};function getRank(index){if(typeof $(this).data(pluginName)!=='undefined'){return $(this).data(pluginName).getRank(index);}else{return'';}}
function updateChart(){$(this).data(pluginName).updateChart();}
$.fn[pluginName]=function(options){var element=$(this);var name=pluginName;if(options===undefined||typeof options==='object'){return this.map(function(){var $t=$(this);var object=$t.data(name);if(undefined==object){var plugin=new Plugin(element,$.extend(true,{},defaults,options),name);$t.data(name,plugin);}});}else if(typeof options==='string'){var args=Array.prototype.slice.call(arguments);args.splice(0,1);return commands[arguments[0]].apply(element,args);}}}(jQuery,window,document));function valueFormatter_generic_fixed(value,row,index,precision,muted,prefix,postfix){if(typeof prefix==='undefined'){prefix=''}
if(typeof postfix==='undefined'){postfix=''}
if($.isNumeric(value)){value=parseFloat(value);if(typeof precision!=='undefined'){value=value.toFixed(precision);}
return prefix+value+postfix;}else{return value;}}
function percentageFormatter(value,row,index){return valueFormatter_generic_fixed(value,row,index,undefined,false,undefined,' %');}
function valueFormatter_int(value,row,index){return valueFormatter_generic_fixed(value,row,index,0);}
function valueFormatter_float1(value,row,index){return valueFormatter_generic_fixed(value,row,index,1);}
function valueFormatter_float2(value,row,index){return valueFormatter_generic_fixed(value,row,index,2);}
function valueFormatter_float3(value,row,index){return valueFormatter_generic_fixed(value,row,index,3);}
function valueFormatter_float4(value,row,index){return valueFormatter_generic_fixed(value,row,index,4);}
function valueFormatter_generic_exponential(value,row,index,precision,muted,prefix,postfix){if(typeof prefix==='undefined'){prefix=''}
if(typeof postfix==='undefined'){postfix=''}
if($.isNumeric(value)){value=parseFloat(value);if(typeof precision!=='undefined'){value=value.toExponential(precision);}
return prefix+value+postfix;}else{return value;}}
function valueFormatter_float1_exp(value,row,index){return valueFormatter_generic_exponential(value,row,index,1);}
function valueFormatter_float2_exp(value,row,index){return valueFormatter_generic_exponential(value,row,index,2);}
function valueFormatter_float3_exp(value,row,index){return valueFormatter_generic_exponential(value,row,index,3);}
function valueFormatter_float4_exp(value,row,index){return valueFormatter_generic_exponential(value,row,index,4);}
function valueFormatter_int_percentage(value,row,index){return valueFormatter_generic_fixed(value,row,index,0,false,undefined,' %');}
function valueFormatter_float1_percentage(value,row,index){return valueFormatter_generic_fixed(value,row,index,1,false,undefined,' %');}
function valueFormatter_float2_percentage(value,row,index){return valueFormatter_generic_fixed(value,row,index,2,false,undefined,' %');}
function valueFormatter_float3_percentage(value,row,index){return valueFormatter_generic_fixed(value,row,index,3,false,undefined,' %');}
function valueFormatter_float4_percentage(value,row,index){return valueFormatter_generic_fixed(value,row,index,4,false,undefined,' %');}
function valueFormatter_int_error(value,row,index){return valueFormatter_generic_fixed(value,row,index,0,false,'±');}
function valueFormatter_float1_error(value,row,index){return valueFormatter_generic_fixed(value,row,index,1,false,'±');}
function valueFormatter_float2_error(value,row,index){return valueFormatter_generic_fixed(value,row,index,2,false,'±');}
function valueFormatter_float3_error(value,row,index){return valueFormatter_generic_fixed(value,row,index,3,false,'±');}
function valueFormatter_float4_error(value,row,index){return valueFormatter_generic_fixed(value,row,index,4,false,'±');}
function valueFormatter_numeric_with_interval(value,row,index,precision,muted){if(isNumericWithInterval(value)){var item=parseNumericErrorInterval(value,precision);if(typeof muted!=='undefined'&&muted){return item.value+' <small class="text-muted">('+item.value_min+' - '+item.value_max+')</small>';}else{return item.value+' ('+item.value_min+' - '+item.value_max+')';}}else if($.isNumeric(value)){return parseFloat(value).toFixed(precision);}else{return value;}}
function valueFormatter_int_with_interval(value,row,index){return valueFormatter_numeric_with_interval(value,row,index,0,false);}
function valueFormatter_int_with_interval_muted(value,row,index){return valueFormatter_numeric_with_interval(value,row,index,0,true);}
function valueFormatter_float1_with_interval(value,row,index){return valueFormatter_numeric_with_interval(value,row,index,1,false);}
function valueFormatter_float1_with_interval_muted(value,row,index){return valueFormatter_numeric_with_interval(value,row,index,1,true);}
function valueFormatter_float2_with_interval(value,row,index){return valueFormatter_numeric_with_interval(value,row,index,2,false);}
function valueFormatter_float2_with_interval_muted(value,row,index){return valueFormatter_numeric_with_interval(value,row,index,2,true);}
function valueFormatter_float3_with_interval(value,row,index){return valueFormatter_numeric_with_interval(value,row,index,3,false);}
function valueFormatter_float3_with_interval_muted(value,row,index){return valueFormatter_numeric_with_interval(value,row,index,3,true);}
function valueFormatter_float4_with_interval(value,row,index){return valueFormatter_numeric_with_interval(value,row,index,4,false);}
function valueFormatter_float4_with_interval_muted(value,row,index){return valueFormatter_numeric_with_interval(value,row,index,4,true);}
function valueFormatter_plusminus(value,row,index,precision,muted){if(isNumericWithError(value)){var item=parseNumericErrorPlusminus(value,precision);if(typeof muted!=='undefined'&&muted){return item.value+' <small class="text-muted">±'+item.value_plusminus+'</small>';}else{return item.value+' ±'+item.value_plusminus;}}else if($.isNumeric(value)){return parseFloat(value).toFixed(precision);}else{return value;}}
function valueFormatter_int_plusminus(value,row,index){return valueFormatter_plusminus(value,row,index,0,false);}
function valueFormatter_int_plusminus_muted(value,row,index){return valueFormatter_plusminus(value,row,index,0,true);}
function valueFormatter_float1_plusminus(value,row,index){return valueFormatter_plusminus(value,row,index,1,false);}
function valueFormatter_float1_plusminus_muted(value,row,index){return valueFormatter_plusminus(value,row,index,1,true);}
function valueFormatter_float2_plusminus(value,row,index){return valueFormatter_plusminus(value,row,index,2,false);}
function valueFormatter_float2_plusminus_muted(value,row,index){return valueFormatter_plusminus(value,row,index,2,true);}
function valueFormatter_float3_plusminus(value,row,index){return valueFormatter_plusminus(value,row,index,3,false);}
function valueFormatter_float3_plusminus_muted(value,row,index){return valueFormatter_plusminus(value,row,index,3,true);}
function valueFormatter_float4_plusminus(value,row,index){return valueFormatter_plusminus(value,row,index,4,false);}
function valueFormatter_float4_plusminus_muted(value,row,index){return valueFormatter_plusminus(value,row,index,4,true);}
function valueFormatter_percentage_with_interval(value,row,index,precision,muted){if(isNumericWithInterval(value)){var item=parseNumericErrorInterval(value,precision);if(typeof muted!=='undefined'&&muted){return item.value+' % <small class="text-muted">('+item.value_min+' - '+item.value_max+')</small>';}else{return item.value+' % ('+item.value_min+' - '+item.value_max+')';}}else if($.isNumeric(value)){return parseFloat(value).toFixed(precision)+' %';}else{return value;}}
function valueFormatter_int_percentage_with_interval(value,row,index){return valueFormatter_percentage_with_interval(value,row,index,0,false);}
function valueFormatter_int_percentage_with_interval_muted(value,row,index){return valueFormatter_percentage_with_interval(value,row,index,0,true);}
function valueFormatter_float1_percentage_with_interval(value,row,index){return valueFormatter_percentage_with_interval(value,row,index,1,false);}
function valueFormatter_float1_percentage_with_interval_muted(value,row,index){return valueFormatter_percentage_with_interval(value,row,index,1,true);}
function valueFormatter_float2_percentage_with_interval(value,row,index){return valueFormatter_percentage_with_interval(value,row,index,2,false);}
function valueFormatter_float2_percentage_with_interval_muted(value,row,index){return valueFormatter_percentage_with_interval(value,row,index,2,true);}
function valueFormatter_float3_percentage_with_interval(value,row,index){return valueFormatter_percentage_with_interval(value,row,index,3,false);}
function valueFormatter_float3_percentage_with_interval_muted(value,row,index){return valueFormatter_percentage_with_interval(value,row,index,3,true);}
function valueFormatter_float4_percentage_with_interval(value,row,index){return valueFormatter_percentage_with_interval(value,row,index,4,false);}
function valueFormatter_float4_percentage_with_interval_muted(value,row,index){return valueFormatter_percentage_with_interval(value,row,index,4,true);}
function valueFormatter_percentage_plusminus(value,row,index,precision,muted){if(isNumericWithError(value)){var item=parseNumericErrorPlusminus(value,precision);if(typeof muted!=='undefined'&&muted){return item.value+' % <small class="text-muted">±'+item.value_plusminus+'</small>';}else{return item.value+' % ±'+item.value_plusminus;}}else if($.isNumeric(value)){return parseFloat(value).toFixed(precision)+' %';}else{return value;}}
function valueFormatter_int_percentage_plusminus(value,row,index){return valueFormatter_percentage_plusminus(value,row,index,0,false);}
function valueFormatter_int_percentage_plusminus_muted(value,row,index){return valueFormatter_percentage_plusminus(value,row,index,0,true);}
function valueFormatter_float1_percentage_plusminus(value,row,index){return valueFormatter_percentage_plusminus(value,row,index,1,false);}
function valueFormatter_float1_percentage_plusminus_muted(value,row,index){return valueFormatter_percentage_plusminus(value,row,index,1,true);}
function valueFormatter_float2_percentage_plusminus(value,row,index){return valueFormatter_percentage_plusminus(value,row,index,2,false);}
function valueFormatter_float2_percentage_plusminus_muted(value,row,index){return valueFormatter_percentage_plusminus(value,row,index,2,true);}
function valueFormatter_float3_percentage_plusminus(value,row,index){return valueFormatter_percentage_plusminus(value,row,index,3,false);}
function valueFormatter_float3_percentage_plusminus_muted(value,row,index){return valueFormatter_percentage_plusminus(value,row,index,3,true);}
function valueFormatter_float4_percentage_plusminus(value,row,index){return valueFormatter_percentage_plusminus(value,row,index,4,false);}
function valueFormatter_float4_percentage_plusminus_muted(value,row,index){return valueFormatter_percentage_plusminus(value,row,index,4,true);}
...
function valueFormatter_inline_bar_vertical(value,row,index){var items=value.split(',');var html='';if(items.length>0){html+='<canvas class="datatable-inline-bar-vertical" data-value="'+value+'"></canvas>';}
return html;}
function valueFormatter_inline_bar_vertical_tristate(value,row,index){var items=value.split(',');var html='';if(items.length>0){html+='<canvas class="datatable-inline-bar-vertical-tristate" data-value="'+value+'"></canvas>';}
return html;}
function valueFormatter_inline_line(value,row,index){var items=value.split(',');var html='';if(items.length>0){html+='<canvas class="datatable-inline-line" data-value="'+value+'"></canvas>';}
return html;}
function valueFormatter_inline_line_steps(value,row,index){var items=value.split(',');var html='';if(items.length>0){html+='<canvas class="datatable-inline-line-steps" data-value="'+value+'"></canvas>';}
return html;}
function valueFormatter_inline_pie(value,row,index){var items=value.split(',');var html='';if(items.length>0){html+='<canvas class="datatable-inline-pie" data-value="'+value+'"></canvas>';}
return html;}
function runningFormatter(value,row,index){return(index+1);}
function isNumericWithInterval(value){var regex=/[+-]?\d+(?:\.\d+)\s+\([+-]?\d+(?:\.\d+)\s+-\s+[+-]?\d+(?:\.\d+)\)/g;var pattern=new RegExp(regex);return pattern.test(value);}
function isNumericWithError(value){var pattern_plusminus=new RegExp(/([+-]?([0-9]*[.])?[0-9]+)(\s+)?[±](\s+)?(([0-9]*[.])?[0-9]+)/);return pattern_plusminus.test(value);}
function numericToFloat(value,precision){if(typeof value==='string'||value instanceof String){value=value.replace('%','');}
...
if($.inArray(cookie,cookies)===-1){cookies.push(cookie);}});return cookies;}};var initFilterSelectControls=function(that){var data=that.data,itemsPerPage=that.pageTo<that.options.data.length?that.options.data.length:that.pageTo,isColumnSearchableViaSelect=function(column){return column.filterControl&&column.filterControl.toLowerCase()==='select'&&column.searchable;},isFilterDataNotGiven=function(column){return column.filterData===undefined||column.filterData.toLowerCase()==='column';},hasSelectControlElement=function(selectControl){return selectControl&&selectControl.length>0;};var z=that.options.pagination?(that.options.sidePagination==='server'?that.pageTo:that.options.totalRows):that.pageTo;$.each(that.header.fields,function(j,field){var column=that.columns[$.fn.bootstrapTable.utils.getFieldIndex(that.columns,field)],selectControl=$(that.$el).find('.bootstrap-table-filter-control-'+escapeID(column.field));if(isColumnSearchableViaSelect(column)&&isFilterDataNotGiven(column)&&hasSelectControlElement(selectControl)){if(selectControl.get(selectControl.length-1).options.length===0){addOptionToSelectControl(selectControl,'','');}
var uniqueValues={};for(var i=0;i<z;i++){var fieldValue=data[i][field].trim();var $fieldValue=$(fieldValue);var fieldValueArray=[];if($fieldValue.length){$fieldValue.each(function(index){fieldValueArray.push($(this).text().trim());});}else{var comma=fieldValue.split(',');comma.forEach(function(item){fieldValueArray.push(item.trim());});}
...
var that=this;var fp=$.isEmptyObject(this.filterColumnsPartial)?null:this.filterColumnsPartial;this.data=fp?$.grep(this.data,function(item,i){for(var key in fp){var thisColumn=that.columns[$.fn.bootstrapTable.utils.getFieldIndex(that.columns,key)];var fval=fp[key].toLowerCase();var value=item[key].replace(/<(?:.|\n)*?>/gm,'');if(thisColumn&&thisColumn.searchFormatter){value=$.fn.bootstrapTable.utils.calculateObjectValue(that.header,that.header.formatters[$.inArray(key,that.header.fields)],[value,item,i],value);}
...
function createResizer(handler){var resizer=document.createElement('div');var cls=CSS_PREFIX+'size-monitor';var maxSize=1000000;var style='position:absolute;'+
'left:0;'+
'top:0;'+
'right:0;'+
'bottom:0;'+
...
'pointer-events:none;'+
'visibility:hidden;'+
'z-index:-1;';resizer.style.cssText=style;resizer.className=cls;resizer.innerHTML='<div class="'+cls+'-expand" style="'+style+'">'+
'<div style="'+
'position:absolute;'+
'width:'+maxSize+'px;'+
'height:'+maxSize+'px;'+
...
'top:0">'+
'</div>'+
'</div>';var expand=resizer.childNodes[0];var shrink=resizer.childNodes[1];resizer._reset=function(){expand.scrollLeft=maxSize;expand.scrollTop=maxSize;shrink.scrollLeft=maxSize;shrink.scrollTop=maxSize;};var onScroll=function(){resizer._reset();handler();};addEventListener(expand,'scroll',onScroll.bind(expand,'expand'));addEventListener(shrink,'scroll',onScroll.bind(shrink,'shrink'));return resizer;}
...
module.exports={_enabled:typeof window!=='undefined'&&typeof document!=='undefined',initialize:function(){var keyframes='from{opacity:0.99}to{opacity:1}';injectCSS(this,'@-webkit-keyframes '+CSS_RENDER_ANIMATION+'{'+keyframes+'}'+
'@keyframes '+CSS_RENDER_ANIMATION+'{'+keyframes+'}'+
'.'+CSS_RENDER_MONITOR+'{'+
'-webkit-animation:'+CSS_RENDER_ANIMATION+' 0.001s;'+
'animation:'+CSS_RENDER_ANIMATION+' 0.001s;'+
'}');},acquireContext:function(item,config){if(typeof item==='string'){item=document.getElementById(item);}else if(item.length){item=item[0];}
